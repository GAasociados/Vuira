                ...
                <div class="row">
                    <div class="col-sm-6 col-md-8">
                        <dl class="dl-horizontal">
                            <dt>Encargado</dt> <dd><?php echo "$email->nombres $email->apellido" ?></dd>
                            <dt>Departamento</dt> <dd><?php echo $email->departamento ?></dd>
                            <dt>Rango</dt> <dd><?php echo $email->rango ?></dd>
                            <dt>Disponible</dt> <dd><?php echo $email->dias_disponibles ?></dd>
                            <dt>Horario </dt> <dd><?php echo "$email->tiempo_inicio - $email->tiempo_final" ?></dd>
                        </dl>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <dl class="dl-horizontal">
                            <dt>Serial No</dt> <dd>#<?php echo ($email->serial_no <= 9) ? "0$email->serial_no" : $email->serial_no ?></dd>
                            <dt>Día</dt> <dd><?php echo $email->dia ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-body"  id="PrintMe">  
                <div class="row">
                    ...
                    <div class="col-sm-3" align="center"> 
                        <img alt="Picture" src="<?php echo (!empty($email->foto) ? base_url($email->foto) : base_url("assets/images/no-img.png")) ?>" class="img-thumbnail img-responsive">
                        <h3><?php echo "$email->nombre_completo " ?></h3>
                    </div>

                    <div class="col-sm-9"> 
                        <dl class="dl-horizontal">
                            <?php // die(print_r($cita, TRUE));?>
                            <dt>Cita ID</dt><dd><?php echo $email->citas_id ?></dd>
                            <dt>Ciudadano </dt><dd><?php echo "$email->nombre_completo " ?></dd>

                            <dt>Fecha de Cita</dt><dd><?php echo date('d M Y', strtotime($email->dia)) ?></dd> 
                            <dt>Hora de Cita</dt><dd><?php echo $email->hora_cita ?></dd> 
                            <dt>Teléfono</dt><dd><?php echo $email->celular ?></dd> 
                            <dt>Asunto</dt><dd><?php echo $email->asunto ?></dd> 
                        </dl> 
                    </div>
                </div>  
