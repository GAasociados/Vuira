...
class Avaluos_urbanos_model extends CI_Model
{

    public $table = 'avaluos_urbanos';
    public $id = 'ID';
    public $order = 'DESC';
    ...
    function getMaxItemByid(){
      $consulta = $this->db->query("SELECT MAX(ID) as maximo FROM avaluos_urbanos");
...
/* End of file Avaluos_urbanos_model.php */
/* Location: ./application/models/Avaluos_urbanos_model.php */
/* Please DO NOT modify this information : */
/* GA & Asociados 2017-06-14 17:05:20 */
