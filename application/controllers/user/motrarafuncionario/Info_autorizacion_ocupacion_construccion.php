...
class Info_autorizacion_ocupacion_construccion extends CI_Controller {
	...
	public function index(){
		if ($this->session->userdata("login")) {
			$data['archivojs'] = base_url()."assets/js/tram/autorizacionocupacionconstruccion/mostrarautorizacionocupacionconstruccionfuncionario.js";
	...
	public function documentacion(){
 		if ($this->session->userdata("login")) {
 			$data['archivojs'] = base_url()."assets/js/tram/autorizacionocupacionconstruccion/mostrarautorizacionocupacionconstruccionfuncionariodocumentacion.js";
 			$this->load->view('funcionariotramites/us_autorizacionocupacionconstruccion',$data);
 		}
 		else{
 			header("Location:".base_url()."home");
