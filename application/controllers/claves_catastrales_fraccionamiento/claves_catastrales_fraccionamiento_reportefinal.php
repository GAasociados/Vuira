...
<!--         
          ...
          <h4><i class="glyph-icon icon-question-circle "></i>&nbsp;Ayuda</h4> 
                    ...
                    <h2>Resultado Reporte Claves Catastrales Fraccionamiento.</h2><br>
...
<!--                                          Mis Trámites-->
                                    ...
                                    <div class="col-md-2">
                    <a href="<?php echo base_url(); ?>claves_catastrales_fraccionamiento/reportes" class="btn btn-danger glyph-icon icon-times">Cancelar Búsqueda</a>
                                        </div>
                    
                                    <form target="_blank" action="<?php echo base_url(); ?>claves_catastrales_fraccionamiento/reportespdf" method="POST">
                                        ...
                                        foreach ($claves_catastrales_fraccionamiento_data as $claves_catastrales_fraccionamiento)
                                        {
                                          if($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155){
                                             ...
                                             <tr>
                                               <td>
                                                 <?php
                                                 if ($claves_catastrales_fraccionamiento->fechainicio == "0000-00-00") {
                                                   echo "El trámite aún no ha Iniciado";
                                                 }
                                                 else {
                                                   echo $claves_catastrales_fraccionamiento->fechainicio;
                                                 }
                                                 ?>
                                               </td>
                                               <td>
                                                 <?php
                                                 if ($claves_catastrales_fraccionamiento->fechafinal == "0000-00-00") {
                                                   echo "El trámite aún no ha finalizado";
                                                 }
                                                 else {
                                                   echo $claves_catastrales_fraccionamiento->fechafinal;
                                                 }
                                                 ?>
                                               </td>
                                             ...
                                             <td>
                                               <?php if (empty($claves_catastrales_fraccionamiento->doctofinal)) {
                                             ...
                                             <td>
                                               <?php switch ($claves_catastrales_fraccionamiento->status) {
                                                 case '1':
                                                   echo "Iniciado";
                                                   break;
                                              ...
                                              <td>
                                                ...
                                                <?php echo anchor(site_url('claves_catastrales_fraccionamiento/read/' . $claves_catastrales_fraccionamiento->ID), '<button class="btn btn-info"><i class="glyph-icon icon-eye"></i> Ver</button>');?>
