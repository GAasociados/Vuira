    ...
    <body>
        ...
        <div id="page-content-wrapper">
          ...
          <h4><i class="glyph-icon icon-question-circle "></i>&nbsp;Ayuda</h4> 
                    ...
                    <h2>Mis Trámites Clave Catastral Fraccionamiento</h2><br>
...
//                                            
                                                    ...
                                                    <td style="text-align:center" width="200px">
                                                        ...
                                                        //echo ' | ';
                                                        echo anchor(site_url('claves_catastrales_fraccionamiento/update/' . $claves_catastrales_fraccionamiento->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                                                        ?>
                                                    </td>
                                                </tr>
                                                <?php
