...
//$data = array('ID' => $fila->ID,'u1' => $fila->nombrepropietarioinmuebledg,'u2' => $file->calledg." ".$file->numerodg,'u3' => $arraycoloniau4->colonia." Irapuato, Gto.");
        ...
        $data['Comunt'] = $this->input->post('Comunt');
...
// Creating the new document...
        ...
        $document->setValue('coop', $this->input->post('coop'));
        ...
        $detallespredio = "";
        if ($this->input->post('Privativat') || $this->input->post('Cubiertat') || $this->input->post('Comunt')):
            ...
            if ($this->input->post('indivisott')):
                ...
                if ($this->input->post('Comunt')):
                    $detallespredio = $detallespredio . ", de los cuales " . $this->input->post('Comunt') . " m² de área común";
                endif;
...
//        die(print_r(date("Y-m-d"),true));
        ...
        $data2['areac'] = $this->input->post('Comun') != "" ? 1 : 0;
        $data2['areact'] = $this->input->post('Comunt');
...
//        die(print_r(date("Y-m-d"),true));
    ...
    public function documentoimuvii_vista()
    {
        $id = $this->input->post('ID');
        $row = $this->Claves_catastrales_individual_model->get_by_id_administrador($id);
        if($row->cbocoloniaui>0 || $row->cbocoloniaui!="") {
            $row2 = $this->Colonias_model->getalladatacoloniabyidpredial($row->cbocoloniaui);
            $colonia=$row2->NOMBRE;
        } else {
            $colonia=$row->coloniados;
        }
...
//          $data['Cubiertad'] = $this->input->post('Cubiertad');
        ...
        $data['numero_doc'] = $this->input->post('Oficio');
        $data['croquis'] = $row->croqis;
        $data['coloniados'] = $row->coloniados;
...
// Creating the new document...
        ...
        $document->setValue('superficie', $this->input->post('sup'));
        $document->setValue('colonia', $this->input->post('colonia'));
        $document->setValue('predial', $this->input->post('predial'));
        if ($row->predialui != "N/A") {
            $document->setValue('cuentapredial', " bajo la cuenta predial " . $row->predialui . " ");
        } else {
            $document->setValue('cuentapredial', "");
...
//        die(print_r($data, true));
        ...
        if ($this->input->post('tipodocumento') == 2)
            $document = $PHPWord->loadTemplate('assets/constancia_ejidal.docx');
        elseif ($this->input->post('tipodocumento') == 4)
            $document = $PHPWord->loadTemplate('assets/infonavit.docx');
        elseif ($this->input->post('tipodocumento') == 5)
            $document = $PHPWord->loadTemplate('assets/corett.docx');
        elseif ($this->input->post('tipodocumento') == 6)
            $document = $PHPWord->loadTemplate('assets/titulo_propiedad.docx');
        elseif ($this->input->post('tipodocumento') == 7)
            $document = $PHPWord->loadTemplate('assets/sentencia_juridica.docx');
        elseif ($this->input->post('tipodocumento') == 8)
            $document = $PHPWord->loadTemplate('assets/certificado_parcelario.docx');
        else
            $document = $PHPWord->loadTemplate('assets/pruebas.docx');
...
//$data = array('ID' => $fila->ID,'u1' => $fila->nombrepropietarioinmuebledg,'u2' => $file->calledg." ".$file->numerodg,'u3' => $arraycoloniau4->colonia." Irapuato, Gto.");
        ...
        $data['cmbtipodocumento'] = $this->input->post('cmbtipodocumento');
...
//       die(print_r($data2,true));
        ...
        if ($this->input->post('cmbtipodocumento') == 2)
            $this->load->view('documentos/documentoclavecatastralconstanciaejidal', $data);
        elseif ($this->input->post('cmbtipodocumento') == 4)
            $this->load->view('documentos/documentoclavecatastralinfonavit', $data);
        elseif ($this->input->post('cmbtipodocumento') == 5)
            $this->load->view('documentos/documentoclavecatastralcorett', $data);
        elseif ($this->input->post('cmbtipodocumento') == 6)
            $this->load->view('documentos/documentoclavecatastraltitulopropiedad', $data);
        elseif ($this->input->post('cmbtipodocumento') == 7)
            $this->load->view('documentos/documentoclavecatastralsentenciajuridica', $data);
        elseif ($this->input->post('cmbtipodocumento') == 8)
            $this->load->view('documentos/documentoclavecatastralcertifcadoparcelario', $data);
        else
            $this->load->view('documentos/documentoclavecatastralvista', $data);
    }
