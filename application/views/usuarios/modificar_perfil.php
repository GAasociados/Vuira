                                        ...
                                        <?php if ($this->session->userdata('tipo') == 4 || $this->session->userdata('tipo') == 3) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="apellido_pat" id="apellido_pat" placeholder="Apellido Pat" readonly="true" value="<?php echo $apellido_pat; ?>" />
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <label for="varchar">Apellido Materno <?php echo form_error('apellido_mat') ?></label>
                                                    <input type="text" class="form-control" name="apellido_mat" id="apellido_mat" placeholder="Apellido Mat" readonly="true" value="<?php echo $apellido_mat; ?>" />
                                                </div>
                                                <div class="form-group col-md-3">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="cp" id="cp" placeholder="Cp"  readonly="true" value="<?php echo $cp; ?>" />
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label for="varchar">Correo Electrónico <?php echo form_error('correo') ?></label>
                                                    <input type="text" class="form-control" name="correo" id="correo" placeholder="Correo"  readonly="true" value="<?php echo $correo; ?>" />
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label for="varchar">Teléfono <?php echo form_error('telefono') ?></label>
                                                    <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Telefono" readonly="true"  value="<?php echo $telefono; ?>" />
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="hidden"  name="ifeid" id="" value="<?php echo $identificacionid ?>"placeholder=""/>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="hidden"  name="predialid" id="" value="<?php echo $rpredialid ?>"placeholder=""/>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="hidden"  name="oficialid" id="" value="<?php echo $nooficialid ?>"placeholder=""/>
