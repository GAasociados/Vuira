                        ...
                        <div class="page-head">
                            <div class="container-fluid">
                                <div class="page-title">
                                    <!-- BEGIN PAGE TITLE -->
                                    <h2 style="margin-top:0px">Asignar Director Temporal</h2>
                                    <!-- END PAGE TITLE -->
                                </div>
                            </div>
                        </div>
                        <div class="page-content">
                            <form class="form-horizontal" role="form" action="<?php echo base_url('usuarios/cambioqr_function'); ?>" method="POST"  enctype = "multipart/form-data">
                                <div class="container-fluid">
                                    <!--http://www.eje-central.com.mx/SARE/WS/ws_cat_configuracion_banco.php-->
                                    <div class="container-fluid page-title" style="background-color:  white;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <select>
                                                        ...
                                                        <?php foreach ($func as $fun):?>
                                                        <option value="<?php echo $fun->ID;?>"><?php echo $fun->nombres." ".$fun->apellido_pat." ".$fun->apellido_mat;?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                                <div class="col-md-12 form-group">
                                                    <h4>Documento Nombramiento </h4>
