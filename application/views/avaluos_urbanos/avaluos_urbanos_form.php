        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Autorización de Avalúos Fiscales Urbanos</h2><br>
...
<form id="formclave" action="<?php echo $action; ?>" method="post" enctype = "multipart/form-data">
                                        ...
                                        <?php if ($this->session->userdata('tipo') == 14) { ?>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="file" multiple name="documentofinal[]" id="documentofinal" placeholder="Documento Pago"/>
                                                    <?php if (!empty($documentofinal)): ?>
                                                        <a href="<?php echo base_url() . "assets/tramites/avaluosurbanos/" . $documentofinal; ?>">Descargar</a>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="form-group col-md-6">
 ...
 <button type="submit" class="btn btn-success glyph-icon icon-check">Aceptar Trámite</button>
                                            <?php if ($this->session->userdata('tipo') == 14) { ?>
                                                <a href="<?php echo base_url(); ?>avaluos_urbanos" class="btn btn-azure glyph-icon icon-arrow-circle-left">Regresar</a>
                                            <?php } else { ?>
