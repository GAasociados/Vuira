        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Mis Trámites Avaluos Urbanos</h2><br>
...
<!--                                          Mis Trámites-->
                              ...
                              foreach ($avaluos_urbanos_data as $avaluos_urbanos)
                              {
                                if($this->session->userdata('tipo') == 14){
                                ?>
                                <?php if($avaluos_urbanos->notificacion == 1){ ?>
                                <tr class="note note-warning">
                                <?php }else { ?>
                                <tr>
                                  <?php }?>
                                 <td><?php echo $avaluos_urbanos->nombresolicitante ?></td>
                                 <td><?php echo $avaluos_urbanos->nombrepropietario ?></td>
                                 <td><?php echo $avaluos_urbanos->mensaje ?></td>
                                 <td>
                                     <?php if (empty($avaluos_urbanos->documentofinal)) {
                                       echo "El Documento Final Se Subirá Cuando ".
                                       "El Proceso Del Trámite Esté Terminado";
                                   }else{
                                       echo "<a href='".base_url()."assets/tramites/avaluosurbanos/".$avaluos_urbanos->documentofinal."'>Descargar<a>";
                                   } ?>

                               </td>
                               <td>
                                 <?php switch ($avaluos_urbanos->status) {
                                   case '1':
                                   echo "Iniciado";
                                   break;
                           ...
                           <td style="text-align:center" width="200px">
                            <?php
                            echo anchor(site_url('avaluos_urbanos/update/'.$avaluos_urbanos->ID),'<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                            ?>
                        </td>
                    </tr>
                    <?php
                      ...
                      if ($avaluos_urbanos->usuarioID == $this->session->userdata("id")) {
                        ?>
                        <?php if($avaluos_urbanos->notificacion == 0){ ?>
                        <tr class="note note-warning">
                        <?php }else { ?>
                        <tr>
                          <?php } ?>
                           ...
                           <td style="text-align:center" width="200px">
                            <?php echo anchor(site_url('avaluos_urbanos/update/'.$avaluos_urbanos->ID),'Actualizar');
                          ?>
                        </td>
                      </tr>
                      <?php
