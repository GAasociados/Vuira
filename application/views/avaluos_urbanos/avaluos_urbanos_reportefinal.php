...
<html lang="es">
        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Resultados Reporte Avalúos Urbanos</h2><br>
    ...
    <div class="row" style="margin-bottom: 10px">
                                    ...
                                    <a href="<?php echo base_url(); ?>avaluos_urbanos/reportes" class="btn btn-danger glyph-icon icon-times">Cancelar Búsqueda</a>
...
<!--                                          Reporte-->
                              ...
                              foreach ($avaluos_urbanos_data as $avaluos_urbanos)
                              {
                                ...
                                <tr>
                                  <td>
                                    <?php
                                    if ($avaluos_urbanos->fechainicio == "0000-00-00") {
                                      echo "El trámite aún no ha Iniciado";
                                    }
                                    else {
                                      echo $avaluos_urbanos->fechainicio;
                                    }
                                    ?>
                                  </td>
                                  <td>
                                    <?php
                                    if ($avaluos_urbanos->fechafinal == "0000-00-00") {
                                      echo "El trámite aún no ha finalizado";
                                    }
                                    else {
                                      echo $avaluos_urbanos->fechafinal;
                                    }
                                    ?>
                                  </td>
