...
<?php else:?>
 ...
 <?php endif; ?>se le informa que una vez consultada la base de datos de esta Dirección y la base de datos del padrón de contribuyentes de la Dirección de Impuestos Inmobiliarios, así como la revisión realizada a la documentación que nos anexa se concluye que: 
                        ...
                        El bien inmueble señalado se encuentra inscrito a nombre de <b> <input name="d2" value="<?php echo $d2; ?>" type="hidden"> <?php ECHO $d2; ?> </b>con el carácter de <b><input name="caracter_constancia" value="POSEEDOR" type="hidden">
                        <?php endif; ?> acreditando mediante <?php $constancia; ?>
                             con fecha de <?php
                        setlocale(LC_ALL, "es_ES@euro", "es_ES", "esp");
                        $fecha = strftime("%d de %B de %Y", strtotime($fecha_esc));
                        echo $fecha;
                        ?><input name="fecha_esc" value="<?php echo $fecha; ?>" type="hidden"> de la ciudad de Irapuato, Gto.
