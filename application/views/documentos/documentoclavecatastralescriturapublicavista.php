...
<?php else:?>
 ...
 <?php endif; ?>se le informa que una vez consultada la base de datos de esta Dirección y la base de datos del padrón de contribuyentes de la Dirección de Impuestos Inmobiliarios, así como la revisión realizada a la documentación que nos anexa se concluye que: 
                        ...
                        echo $fecha;
                        ?><input name="fecha_esc" value="<?php echo $fecha; ?>" type="hidden">con la fe publica del Lic.<b> <input name="lic" value="<?php echo $lic; ?>" type="hidden"> <?php ECHO $lic; ?> </b> Notario Público No. <b> <input name="no_notario" value="<?php echo $no_notario; ?>" type="hidden"> <?php ECHO $no_notario; ?> </b>de la Ciudad de Irapuato Guanajuato, con una superificie de terreno de <b> <input name="sup" value="<?php echo $sup; ?>" type="hidden"> <?php ECHO $sup; ?> </b>.
