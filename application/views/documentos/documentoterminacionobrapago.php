...
<html>
    ...
    <body>
        <form action="<?php echo base_url(); ?>docstramites/documentoconstruccion/documentoplantillapagofinal/<?php echo $ID; ?>" method="post">
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td style="text-align: justify;">
                        ...
                        CANTIDAD DE $ <?php echo number_format(round($pagos), 2) ?> <span id="cantidad3"></span>, DE CONFORMIDAD CON LO DISPUESTO EN EL ARTÍCULO 26 FRACCIÓN VI INCISO C DE LA LEY DE INGRESOS PARA
...
<?php endforeach; ?>
        ...
        echo number_format($pagos1-$v,2);
                ...
                <tr>
                    ...
                    <td colspan="5" style="text-align: right;"></td><td>TOTAL:</td>
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td style="border: 1px solid black; text-align: center;"><?php echo strtoupper($nombrepropietariodg); ?>
                        <br>
                        MISMO QUE PAGARÁ A LA TESORERIA MUNICIPAL DE IRAPUATO LA CANTIDAD DE $<?php echo number_format(round($pagos), 2) ?>  <input type="hidden" name="d18" value="$ <?php echo number_format(round($pagos), 2) ?> ">
                        <br>
    <span id="letras"></span>
                        <input type="hidden" name="d19" id='d19' value="" size="50">
                        <br>
                        (CANTIDAD CON LETRA)
