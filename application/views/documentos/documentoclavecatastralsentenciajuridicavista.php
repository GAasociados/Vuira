...
<?php else:?>
 ...
 <?php endif; ?>se le informa que una vez consultada la base de datos de esta Dirección y la base de datos del padrón de contribuyentes de la Dirección de Impuestos Inmobiliarios, así como la revisión realizada a la documentación que nos anexa se concluye que: 
                        ...
                        El bien inmueble es señalado para otorgamiento de <?php if ($tipo_tramite == 'titulo'): ?>
                            ...
                            <?php endif; ?> a favor del C.<b> <input name="d2" value="<?php echo $d2; ?>" type="hidden"> <?php ECHO $d2; ?> </b> dentro del Juicio Ordinario Civil número <b> <input name="no_juicio" value="<?php echo $no_juicio; ?>" type="hidden"> <?php ECHO $no_juicio; ?> </b>
                            sentencia de fecha del <?php
                            setlocale(LC_ALL, "es_ES@euro", "es_ES", "esp");
                            $fecha = strftime("%d de %B de %Y", strtotime($fecha_esc));
                            echo $fecha;
                            ?><input name="fecha_esc" value="<?php echo $fecha; ?>" type="hidden">resuelto por el Lic.<b> <input name="lic" value="<?php echo $lic; ?>" type="hidden"> <?php ECHO $lic; ?>Juez Primero Civil, de esta Ciudad de Irapuato, Guanajuato.
