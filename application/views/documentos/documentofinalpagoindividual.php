    ...
    <body>
                ...
                <td align="right">
                    <b>
                        ...
                        <script type="text/javascript">
                            var letras = "(" + covertirNumLetras("<?php echo number_format($d19, 2); ?>" + ")");
                        </script>
                    </b>
                </td>
            </tr>
        ...
        <table style="width:100%; floar:left;">
            ...
            <tr>
                ...
                <td></td>
                <td>1</td>
                <td>$<?php echo $costo[0]->costo_base ?></td>
                <td>$<?php echo $costo[0]->costo_tram ?> </td>
                <td>$<?php echo $costo[0]->costo_base + $costo[0]->costo_tram; ?> </td>
            </tr>
            <tr>
                ...
                <td>1</td>
                <td></td>
                <td>$<?php echo $costo[1]->costo_tram ?> </td>
                <td>$<?php echo $costo[1]->costo_base + $costo[1]->costo_tram; ?> </td>
            </tr>
             <tr>
        ...
        <table style="width:100%; floar:left;">
            ...
            <tr>
                <td style="border: 1px solid black; text-align: center;">
                    ...
                    <img src="http://chart.googleapis.com/chart?cht=qr&amp;chs=150x150&amp;chl=<?php echo 'ID: ' . $ID . ' Solicitante: ' . $nombrepropietariodg . ' Costo: ' . $d11; ?>&amp;chld=H|0">
                </td>
