...
<html>
    ...
    <body>
        <form action="<?php echo base_url(); ?>docstramites/documentoanuncio/documentofinalpagofraccionamiento/<?php echo $ID; ?>" method="post">
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td rowspan="5" style="text-align: justify;">
                        ...
                        PAGAR A LA TESORERÍA MUNICIPAL LOS DERECHOS CORRESPONDIENTES A LA PRESENTE CLAVE CATASTRAL CERTIFICADA POR LA CANTIDAD DE $<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>
            ...
            <table style="width:100%; floar:center;">
                ...
                <tr>
                    <td>03110004 Clave Catastral Individual  </td>
                    <td></td>
                ...
                <tr>
                    <td> 0310004 Certificación De Clave Catastra  </td>
                    <td></td>
                    <td><?php echo $cantidad; ?></td>
                    <td></td>
  ...
  <tr>
                    ...
                    <?php 
                    $costo2 = $cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram);
                    $costo1 = $cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram);
                ...
                <tr>
                    ...
                    <td colspan="1" ><input type="hidden" name="d11" value="$<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>">$<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?></td>
                </tr>
            </table>
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td style="border: 1px solid black; text-align: center;">
                        <?php $costot = number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>
                    ...
                    <td style="border: 1px solid black; text-align: center;"><?php echo $nombrepropietariodg; ?>
                        <br>
                        MISMO QUE PAGARÁ A LA TESORERIA MUNICIPAL DE IRAPUATO LA CANTIDAD DE <input type="hidden" name="d18" value="$<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>">$<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>
                        <br>
        ...
        <script>
            $("#cantidad2").val("(" + covertirNumLetras("<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>") + ")");
            $("#letras").html("" + covertirNumLetras("<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>"));
            $("#cantidad").html("" + covertirNumLetras("<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>"));
            $("#cantidad3").html("" + covertirNumLetras("<?php echo number_format(round(floatval($cantidad * ($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram)), 0, PHP_ROUND_HALF_DOWN), 2); ?>"));
