...
<body>
    <form action="<?php echo base_url(); ?>docstramites/documentoanuncio/documentofinalpagoindividual/<?php echo $ID; ?>" method="post">
...
CON LA FINALIDAD DE OBTENER LA CLAVE CATASTRAL CERTIFICADA; PREVIO ANÁLISIS PRACTICADO PARA TAL EFECTO SE TIENE LO SIGUIENTE: POR ÚLTIMO, DEBERÁ
PAGAR A LA TESORERÍA MUNICIPAL LOS DERECHOS CORRESPONDIENTES A LA PRESENTE CLAVE CATASTRAL CERTIFICADA POR LA CANTIDAD DE $56.67 
(CINCUENTA Y SEIS PESOS 67/100 M.N.), DE CONFORMIDAD CON LO DISPUESTO EN EL ARTÍCULO 27 FRACCIÓN VIII DE LA LEY DE INGRESOS PARA 
EL MUNICIPIO DE IRAPUATO GUANAJUATO PUBLICADA EN EL PERIÓDICO OFICIAL DEL GOBIERNO DEL ESTADO DE GUANAJUATO, NÚMERO 205 SEXTA PARTE, DE FECHA 
23 DE DICIEMBRE DEL AÑO 2016; MISMAS QUE ENTRARON EN VIGOR A PARTIR DEL 1o DE ENERO DEL AÑO 2018
PARA EL EJERCICIO FISCAL AÑO 2018.
  ...
  <table style="width:100%; floar:left;">
    ...
    <tr>
      <td><input type="text" name="d1" value="Clave Catastral Individual"></td>
