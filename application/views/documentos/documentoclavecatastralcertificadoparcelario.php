    ...
    <table style="width:100%; floar:left;">
        ...
        <tr>
            <td align="justify" style="font-size: 14px;">
                ...
                ?> del inmueble ubicado en <b>PARCELA<?php echo $parcela; ?></b> del Ejido
                <b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato Guanajuato, cuya superficie de terreno es de
                <b> <?php echo $sup; ?> </b> registrado bajo la cuenta predial <?php if ($predial != 'APERTURA'): ?>
                ...
                El bien inmueble señalado se encuentra inscrito a nombre de <b> <?php ECHO $d2; ?> </b>, con el carácter
                de <b><?php echo $caracter; ?></b>, <?php if ($coop): ?>
                    y CO-PROPIETARIO <?php echo $coop; ?>
                <?php endif; ?> acreditado mediante Certificado Parcelario no. <b> <?php echo $no_esc ?> </b> de
                fecha <?php echo $fecha_esc; ?>, de la ciudad de Irapuato, Gto., con una superfie de terreno
                <strong><? echo $sup; ?></strong>.
                ...
                <br>
                Nota: Se hace de su concimiento que la presente clave catastral que se expide solo sirve para la
                ubicacion del inmueble, ya que cuenta con un certificado parcelario l cual solo nos ampara la posesión
                del inmuebe en mención.<br><br>
