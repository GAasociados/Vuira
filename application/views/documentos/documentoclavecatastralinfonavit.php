...
<body>
<form>
    <input type="hidden" name="tipodocumento" value="<?php echo $cmbtipodocumento; ?>">
    ...
    <table style="width:100%; floar:left;">
        ...
        <tr>
            <td align="justify" style="font-size: 14px;">
                ...
                ?> del inmueble ubicado en la calle <b><?php echo $calle; ?></b> con número oficial
                <b> <?php echo $numero;
                    echo $noloteui != "" ? ", " . $noloteui : "";
                    echo $nomanzanaui != "" ? ", " . $nomanzanaui : ""; ?> del
                    Fracc./Colonia/Ejido/Comunidad/Barrio<b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato
                    Guanajuato, cuya superficie de terreno es de <b> <?php echo $sup; ?> </b> registrado bajo la cuenta
                    predial <?php if ($predial != 'APERTURA'): ?>
                        <b> <?php echo $predial; ?></b>
                    <?php else: ?>
                        <b>S/N</b>
                    <?php endif; ?>se le informa que una vez consultada la base de datos de esta Dirección y la base de
                    datos del padrón de contribuyentes de la Dirección de Impuestos Inmobiliarios, así como la revisión
                    realizada a la documentación que nos anexa se concluye que:
                    <br>
                    <br>
                    <!--cambios al documento a partir de aqui-->
                    El bien inmueble señalado se encuentra inscrito a nombre de <b> <?php ECHO $d2; ?> </b>, con el
                    carácter de <b><?php echo $caracter; ?></b>, <?php if ($coop): ?>
                        y CO-PROPIETARIO <?php echo $coop; ?>
                    <?php endif; ?> acreditado mediante <?php if ($tipo_tramite == 'titulo'): ?>
                    ...
                    <?php elseif ($tipo_tramite == 'info'): ?>
                        Contrato Privado de Compraventa INFONAVIT No. <?php echo $noesc; ?>
                    <?php elseif ($tipo_tramite == 'escritura') : ?>
                        la Escritura Pública No.<?php echo $noesc; ?>
                    <?php endif; ?>
                    con fecha del <?php echo $fecha_esc; ?> Como el Lote número <?php echo $noloteui; ?> de la
                    Manzana <?php echo $nomanzanaui; ?> del Fraccionamiento <?php echo $fraccionamiento; ?>de esta
                    Ciudad de Irapuato, Gto., con una superfie de terreno <strong><? echo $sup; ?></strong>.
                    <?php if ($Privativat || $Cubiertat || $Comunt): ?>  Como lote <?php echo $noloteui; ?> área privativa
                        con <?php if ($indivisott): ?>
                            área total de indiviso de <?php echo $indivisott; ?> m2 <input name="indivisott"
                                                                                           value="<?php echo $indivisott; ?>"
                                                                                           type="hidden">
                            <?php if ($Privativat): ?>
                                de los cuales <?php echo $Privativat; ?> m2 son de área privativa<input
                                name="Privativat"
                            ...
                            <?php if ($Comunt): ?>
                                de los cuales <?php echo $Comunt; ?> m2 son de área común<input name="Comunt"
                                                                                                ...
                                                                                                type="hidden">
                            <?php endif; ?>
                            <?php if ($Cubiertat): ?>, <?php echo $Cubiertat; ?> m2 son de área común cubierta<input
                                    name="Cubiertat" value="<?php echo $Cubiertat; ?>" type="hidden">
                            <?php endif; ?>
                            <?php if ($Cubiertatd): ?>, <?php echo $Cubiertatd; ?> m2 son de área común descubierta
                                <input
                    ...
                    <br><br>
                    Para efectos de la inscripción al padrón catastral, integración a la cartográfia del Municipio,
                    localización geográfica e identificación del predio de forma única, se le ha asignado a éste
                    inmueble la Clave Catastral número:
                    <br>
            </td>
        </tr>
    </table>
    ...
    <table style="width:100%; floar:left; font-size: 14px;">
        ...
        <tr>
            <td align="justify">
                ...
                primer párrafo, 39 Fracción I; Constitución Política para el Estado de Guanajuato, Artículo 23 Fracción
                V; Ley de Responsabilidades Administrativas de los Servidores Públicos del Estado de Guanajuato y sus
                Municipios, Artículo 11 Fracción III; Código Territorial para el Estado de Guanajuato y sus Municipios,
                Artículos 193 Fracción III, 194 Fracción I y II, 195,197 Fracciones I y IV, 202, 204, 205, 206, 207,
                208, 209;
                Reglamento Orgánico de la Administración Pública Municipal de Irapuato Guanajuato, en su numeral 75
                Fracciones II, VI y VII; Así como lo contemplado en la Norma Técnica del Sistema Nacional de Informacion
                Estadística y Geográfica Artículos 1, 2, 3 Fracciones I, IV, VII, 6 y 7; Ley de Ingresos para el
                Municipio de Irapuato Guanajuato, Artículos 27 Fracción VII y 32 Fracción IV.
            </td>
        </tr>
    </table>
    <br>
    ...
    <table>
        ...
        <tr>
            <td align="justify" STYLE=" text-align: center;  font-size: 14px;">
                ...
                No. <?php echo $numero_exp; ?> los cuales se encuentran en el archivo de esta Dirección, mismo que tuve
                a la vista y con el que fue cotejado.
                <br>
                <br>
                <br>
