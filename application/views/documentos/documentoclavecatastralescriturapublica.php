            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td align="justify" style="font-size: 14px;">
                        ...
                        ?> del inmueble ubicado en la calle <b><?php echo $calle; ?></b> con número oficial <b> <?php echo $numero; echo $noloteui !=""? ", ".$noloteui:"" ; echo $nomanzanaui !=""? ", ".$nomanzanaui:""; ?> del Fracc./Colonia/Ejido/Comunidad/Barrio<b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato Guanajuato, cuya superficie de terreno es de <b> <?php echo $sup; ?> </b> registrado bajo la cuenta predial <?php if ($predial != 'APERTURA'): ?>
                    ...
                    <br>
                        ...
                        El bien inmueble señalado se encuentra acreditado a nombre de <b> <?php ECHO $d2; ?> </b>, con el carácter de <b><?php echo $caracter; ?></b>, <?php if ($coop): ?>
                            y CO-PROPIETARIO <?php echo $coop; ?>
                        <?php endif; ?> acreditado mediante <b> <?php echo $tipo_tramite; ?> </b> del <?php echo $fecha_esc; ?> con la fe publica del Lic. <?php echo $lic; ?>Notario Público No. <?php echo $no_notario; ?> de la ciudad de Irapuato Guanajuato, con una superficie de terreno <b>  <?php echo $sup; ?> </b>.
                        <br><br>
