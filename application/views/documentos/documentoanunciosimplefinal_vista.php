...
<html>
    ...
    <body>
        <form  action="<?php echo base_url(); ?>docstramites/documentoanunciosimple/documentofinal" method="post">
                ...
                <tr>
                    <td align="right">
                        <b>
                            ...
                            <br>
                            <?php echo $d1; ?><input type="hidden" name="d1" value="<?php echo $d1 ; ?>">
                            <br>
                            PERMISO DE ANUNCIOS
                            <br>
            ...
            <table style="width:100%; floar:left; border: 1px solid black;">
                    ...
                    <td colspan="3" style="border: 1px solid black;">
                        ...
                        if ($d2) {
                            ...
                            <?php foreach ($d2 as $ant) { ?>
                                <b><?php echo $ant['nombre']; ?>
                                    <input name="d2[<?php echo $i; ?>][nombre]"  type="hidden" value="<?php echo $ant['nombre']; ?>"></b><br>
                                <?php echo $ant['comentarios']; ?>
                                <input name="d2[<?php echo $i; ?>][comentarios]"  type="hidden" value="<?php echo $ant['comentarios']; ?>">
                                <br>
                ...
                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;">
                        ...
                        <input name="opl"  type="hidden" value="<?php echo $op1; ?>">
                    </td>
                    <td colspan="3" style="border: 1px solid black;">
                        <?php echo $u4; ?>
                ...
                <tr style="border: 1px solid black;">
                    ...
                    <td style="border: 1px solid black;"><?php echo $d10; ?>
                        <input name="d10"  type="hidden" value="<?php echo $d10; ?>"></td>
                    <td style="border: 1px solid black;">UGAT <?php echo $d11; ?>
                        <input name="d11"  type="hidden" value="<?php echo $d11; ?>"></td>
                    <td style="border: 1px solid black;">Superficie del Predio: <?php echo $u5; ?> m²</td>
                </tr>
                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;">Uso:</td>
                    <td style="border: 1px solid black;"><?php echo $d12; ?>
                        <input name="d12"  type="hidden" value="<?php echo $d12; ?>"></td>
                    <td style="border: 1px solid black;" colspan="2">Clave Catastral: <?php echo $d13; ?>
                        <input name="d13"  type="hidden" value="<?php echo $d13; ?>"></td>
                </tr>
            </table>
            ...
            <table style="border: 1px solid black;" width="100%">
                <tr style="border: 1px solid black;">
                    ...
                    <td style="border: 1px solid black;">
                        <?php echo $d14; ?>
                        <input name="d14"  type="hidden" value="<?php echo $d14; ?>">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid black;">
                        <?php echo $d15; ?>
                        <input name="d15"  type="hidden" value="<?php echo $d15; ?>">
                    </td>
                </tr>
                <tr style="border: 1px solid black;">
                    ...
                    <td style="border: 1px solid black;">
                        <?php echo $d16; ?>
                        <input name="d16"  type="hidden" value='<?php echo $d16; ?>'>
                    </td>
                </tr>
                <tr style="border: 1px solid black;">
                    ...
                    <td style="border: 1px solid black;">
                        <?php echo $d18; ?>
                        <input name="d18"  type="hidden" value='<?php echo $d18; ?>'>
                    </td>
                </tr>
                <tr style="border: 1px solid black;">
                ...
                <input name="d19"  type="hidden" value="<?php echo $d19; ?>">
                </tr>
                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;">Número de las Carteleras:</td>
                    <td style="border: 1px solid black;"><?php echo $d20; ?></td>
                <input name="d20"  type="hidden" value="<?php echo $d20; ?>">
                </tr>

                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;">Dimensiones de las Carteleras:</td>
                    <td style="border: 1px solid black;"><?php echo $d21; ?>
                        <input name="d21"  type="hidden" value="<?php echo $d21; ?>"></td>
                </tr>

                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;">Referente a:</td>
                    <td style="border: 1px solid black;"><?php echo $d22; ?>
                        <input name="d22"  type="hidden" value="<?php echo $d22; ?>"></td>
                </tr>

                <tr style="border: 1px solid black;">
                    <td colspan="2" style="border: 1px solid black;">
                        Póliza: <?php echo $d23; ?>
                        <input name="d23"  type="hidden" value="<?php echo $d23; ?>">
                    </td>
                </tr>
               ...
               <?php if ($d50): 
                ...
                <?php foreach ($detalles as $an): ?>
                    <tr>
                        ...
                        <td colspan="2"><?php echo  $aux[0]; ?></td>
                        
                        <td align="center"  ><?php echo $aux[1]; ?></td>
                           <td align="center"  ><?php echo $aux[2]; ?></td>
                           <td align="center"  ><?php echo $aux[3]; ?></td>
                    </tr>
                    <?php
                endforeach;
            endif;
            ?>
                <tr>
                    ...
                    <td align="center"><?php echo '$ ' . $d60; ?></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                     <td align="center" width="35%"><label>Validación</label><br>
                    ...
                    <td width="50%" align="justify">
                        ...
                        <input name="d35"  type="hidden" value="<?php echo $d35; ?>">
                        <br>
                        -Se integra con <?php echo $d36; ?>
                        <input name="d36"  type="hidden" value="<?php echo $d36; ?>">
                        <br>
                        Revisó: <?php echo $d37; ?>
                        <input name="d37"  type="hidden" value="<?php echo $d37; ?>">
                        <br>
                        Elaboró:
                        <?php echo $d38; ?>
                        <input name="d38"  type="hidden" value="<?php echo $d38; ?>">
                        <br>
                        Zona Norponiente
                    </td>
                    <td align="center" width="15%"><label>Nombramiento</label><br>
