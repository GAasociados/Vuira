        ...
        <form action="<?php echo base_url(); ?>docstramites/documentoanuncio/documentofinalpagoindividual/<?php echo $ID; ?>" method="post">
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black; text-align: center;">FECHA DE AUTORIZACIÓN</td>
                </tr>
                <tr>
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    ...
                    <td colspan="" style="">
                        <input type="hidden" name="d11" aditionaltag="$<?php echo number_format(round($costo1 + round($costo2-$costo1,2), 2), 2); ?>" 
                               value="$<?php echo number_format(round(floatval($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram), 0, PHP_ROUND_HALF_DOWN), 2); ?> ">
                        $<?php echo number_format(round(floatval($costo[0]->costo_base + $costo[0]->costo_tram + $costo[1]->costo_base + $costo[1]->costo_tram), 0, PHP_ROUND_HALF_DOWN), 2); ?>
                    </td>
                </tr>
