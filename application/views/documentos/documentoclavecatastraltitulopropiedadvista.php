                ...
                <tr>
                    <td align="justify" style="font-size: 14px;">
                        ...
                        ?>  " type="hidden">
                                                              ...
                                                              ?> del inmueble ubicado en la calle <b><input name="calle" value="<?php echo $calle ?>" type="hidden"> <?php echo $calle; ?></b> con número oficial <b><input name="numero" value="<?php echo $numero; ?>" type="hidden"> <?php echo $numero; echo $noloteui !=""? ", ".$noloteui:"" ; echo $nomanzanaui !=""? ", ".$nomanzanaui:""; ?>  </b> <b>PARCELA <input name="parcela" value="<?php echo $parcela; ?>" type="hidden"> <?php echo $parcela; ?> </b> del Fracc./Colonia/Ejido/Comunidad/Barrio<b><input name="colonia" value="<?php echo $colonia; ?>" type="hidden"> <?php echo $colonia; ?></b> de esta ciudad de Irapuato Guanajuato, cuya superficie de terreno es de <b><input name="sup" value="<?php echo $sup ?>" type="hidden"> <?php echo $sup; ?> </b> registrado bajo la cuenta predial <?php if ($predial != 'APERTURA'): ?>
...
<?php else:?>
 ...
 <?php endif; ?>se le informa que una vez consultada la base de datos de esta Dirección y la base de datos del padrón de contribuyentes de la Dirección de Impuestos Inmobiliarios, así como la revisión realizada a la documentación que nos anexa se concluye que: 
                        ...
                        <?php endif; ?> con fecha de <?php
                        setlocale(LC_ALL, "es_ES@euro", "es_ES", "esp");
                        $fecha = strftime("%d de %B de %Y", strtotime($fecha_esc));
                        echo $fecha;
                        ?><input name="fecha_esc" value="<?php echo $fecha; ?>" type="hidden">con la fe publica del Delegado del Registro Agrario Nacional C.<b> <input name="delegado" value="<?php echo $delegado; ?>" type="hidden"> <?php ECHO $delegado; ?> </b>
                        como Parcela número <b> <input name="parcela" value="<?php echo $parcela; ?>" type="hidden"> <?php ECHO $parcela; ?> </b> del Ejido <b> <input name="colonia" value="<?php echo $colonia; ?>" type="hidden"> <?php ECHO $colonia; ?> </b> de esta cudad de Irapuato, Gto., con una
                        superficie de <b> <input name="sup" value="<?php echo $sup; ?>" type="hidden"> <?php ECHO $sup; ?> </b>.
                        <br>
                       <br><br>
