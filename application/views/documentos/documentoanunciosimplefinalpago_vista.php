...
<html>
    ...
    <body>
        <form action="<?php echo base_url(); ?>docstramites/documentoanunciosimple/documentofinalpago" method="post">
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td style="border: 1px solid black; text-align: center;"><?php echo strtoupper($nombrepropietariodg); ?>
                        <br>
                        MISMO QUE PAGARÁ A LA TESORERIA MUNICIPAL DE IRAPUATO LA CANTIDAD DE $<?php
//                        $v = floatval($total_pago);
                        echo number_format(round($pagos), 2)
                        ?>
                        <br>
...
?>
            ...
            <table style="width:100%; floar:left;">
                ...
                <tr>
                    <td>REF2: Permiso de Anuncios Adosados</td>
