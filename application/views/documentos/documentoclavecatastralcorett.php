        ...
        <tr>
            <td align="justify" style="font-size: 14px;">
                ...
                <b> <?php echo $numero;
                    ...
                    echo $nomanzanaui != "" ? ", " . $nomanzanaui : ""; ?>  </b> del
                Fracc./Colonia/Ejido/Comunidad/Barrio<b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato
                Guanajuato, con una superficie total <b> <?php echo $sup; ?> </b> registrado bajo la cuenta
                ...
                <?php endif; ?>
                con fecha del <?php echo $fecha_esc; ?> de la ciudad de León, Gto., con una superficie
                de <?php echo $sup; ?>.
