    ...
    <body>
      ...
      <table style="width:100%; floar:left;">
        ...
        <tr style="border: 1px solid black;">
          ...
          <td style="border: 1px solid black;"><?php echo $d4; ?></td>
          <td style="border: 1px solid black;" colspan="2"><?php echo $d5; ?></td>
        </tr>
        <tr>
          <td style="border: 1px solid black;">Uso:</td>
          <td style="border: 1px solid black;"><?php echo $d6; ?></td>
          <td style="border: 1px solid black;" colspan="2">Clave Catastral: <?php echo $d7; ?></td>
        </tr>
      </table>
      ...
      <table style="border: 1px solid black;" width="100%">
        <tr style="border: 1px solid black;">
          ...
          <td colspan="2" style="border: 1px solid black;"><b><?php echo $d8; ?></b></td>
        </tr>
        <tr>
        ...
        <tr style="border: 1px solid black;">
          ...
          <td colspan="2" style="border: 1px solid black;"><?php echo $d10; ?></td>
        </tr>
        <tr style="border: 1px solid black;">
      ...
      <table width="100%">
        <tr>
          ...
          $nombre = $nombrepropietariodg;
           ?>
          <td align=""><img src="http://chart.googleapis.com/chart?cht=qr&amp;chs=140x140&amp;chl=<?php echo $arrayDias[date('w')].", ".date('d')." de ".$arrayMeses[date('m')-1]." de ".date('Y')." -Propietario: ".$nombre;?> -Dirección de Desarrollo Territorial (Autorización para el uso y ocupación de la construcción)&amp;chld=H|0"></td>
          <td>
            Con copia para.-
            <br>
