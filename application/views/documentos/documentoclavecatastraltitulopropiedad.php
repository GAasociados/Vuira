        ...
        <tr>
            <td align="justify" style="font-size: 14px;">
                ...
                <b> <?php echo $numero;
                    ...
                    echo $nomanzanaui != "" ? ", " . $nomanzanaui : ""; ?>  </b> <b>PARCELA <?php echo $parcela; ?></b>
                del Fracc./Colonia/Ejido/Comunidad/Barrio<b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato
                ...
                <?php endif; ?> acreditado mediante <b> <?php echo $tipo_tramite ?> </b> con fecha
                de <?php echo $fecha_esc; ?> con la fe publica del Delegado de Registro Agrario Nacional
                C. <?php echo $delegado; ?>como Parcela número <?php echo $parcela; ?> del Ejido
                <b> <?php echo $colonia; ?></b> de esta ciudad de Irapuato Guanajuato, con una superficie de
                <b>  <?php echo $sup; ?> </b>.
                <?php if ($Privativat || $Cubiertat || $Comunt): ?>  Como lote <?php echo $noloteui; ?> área privativa
                    con <?php if ($indivisott): ?>
                        ...
                        <?php endif; ?>
                        <?php if ($Cubiertatd): ?>, <?php echo $Cubiertatd; ?> m2 son de área común descubierta<input
