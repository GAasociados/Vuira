        ...
        <tr>
            <td align="justify" style="font-size: 14px;">
                ...
                <b> <?php echo $numero;
                    ...
                    El bien inmueble señalado para el otorgamiento de <?php if ($tipo_tramite == 'titulo'): ?>
                    ...
                    <?php endif; ?>
                    a favor del C. <b><?php echo $d2; ?></b> dentro del Juicio Ordinario Civil número
                    <b><?php echo $no_juicio; ?> </b> sentencia de fecha de <?php echo $fecha_esc; ?>
                    resuelto por el Lic. <b><?php echo $lic; ?></b>Juez Primer Civil, de esta ciudad de Irapuato
                    Guanajuato., con una superfie de terreno <strong><? echo $sup; ?></strong>.
