...
<html>
    ...
    <body>
        <form id="doct" method="post" action="<?php echo base_url('docstramites/documentoclave/pruebas1') ?>">
            <div id="mydiv">
...
//                        echo $arrayDias[date('w')] . ", " . date('d') . " de " . $arrayMeses[date('m') - 1] . " de " . date('Y');
                    ...
                    <tr>
                        <td align="justify" style="font-size: 14px;">
                            <br>
                            En atención a su solicitud recibida el día <?php // echo $fechas;   ?> del año en curso respecto a la <?php
// if ($d1 == 1) {
...
//                    } 
                            ?> del inmueble ubicado en la calle <?php // echo $calle; ?> con número oficial <?php
                            // echo $numero;
...
//                    echo $nomanzanaui != "" ? ", " . $nomanzanaui : ""; 
                            ...
                            <?php // if ($Privativat):  ?>
                            de los cuales <?php // echo $Privativat;  ?> m2 de área privativa 

                            <?php // endif;  ?>
                            <?php // if ($Cubiertat): ?>
                            ,  <?php // echo $Cubiertat;  ?> m2 de área común cubierta
                            <?php // endif;  ?>
                            <?php // if ($Cubiertatd): ?>
                            ,  <?php // echo $Cubiertatd;  ?> m2 de área común descubierta 
                            <?php // endif;  ?>
                            <?php // endif; ?>
                            y le corresponde un indiviso del <?php // echo $Indivisopt;   ?>%
                            <?php // endif;  ?>  <?php // if ($tipo_tramite == 'titulo'):  ?>
                            en esta ciudad de <?php // echo $ciudad;  ?>.Con una superfice de <?php // echo $sup;  ?>

                            <?php // elseif ($tipo_tramite == 'cat'): ?>
                            de esta ciudad de <?php // echo $ciudad;   ?>.Con una superfice de <?php // echo $sup;   ?>
                            <?php // endif;  ?>
            ...
            <input name="datoss" id="mydato" type="hidden">
            <button type="submit" id="datos">Generar Word</button>
        </form>
