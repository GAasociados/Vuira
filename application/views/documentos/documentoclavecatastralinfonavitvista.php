                ...
                <tr>
                    <td align="justify" style="font-size: 14px;">
                        ...
                        ?>  " type="hidden">
                                                              ...
                                                              ?> del inmueble ubicado en la calle <b><input name="calle" value="<?php echo $calle ?>" type="hidden"> <?php echo $calle; ?></b> con número oficial <b><input name="numero" value="<?php echo $numero; ?>" type="hidden"> <?php echo $numero; echo $noloteui !=""? ", ".$noloteui:"" ; echo $nomanzanaui !=""? ", ".$nomanzanaui:""; ?>  del Fracc./Colonia/Ejido/Comunidad/Barrio<b><input name="colonia" value="<?php echo $colonia; ?>" type="hidden"> <?php echo $colonia; ?></b> de esta ciudad de Irapuato Guanajuato, cuya superficie de terreno es de <b><input name="sup" value="<?php echo $sup ?>" type="hidden"> <?php echo $sup; ?> </b> registrado bajo la cuenta predial <?php if ($predial != 'APERTURA'): ?>
                        ...
                        <?php endif; ?> acreditando mediante <?php if ($tipo_tramite == 'titulo'): ?>
                            ...
                            <?php elseif ($tipo_tramite == 'info'): ?>
                                <?php if ($delegado != ''): ?>
                                    Autorización del Delegado <?php echo $delegado; ?> <input name="delegado" value="<?php echo $delegado; ?>" type="hidden"> por,
                                <?php endif; ?>
                                Contrato Privado de Compraventa INFONAVIT No.<?php echo $noesc; ?> <input name="tipo_tramite" value="<?php echo $tipo_tramite; ?>" type="hidden"> <input name="numero_exp1" value="<?php echo $noesc; ?>" type="hidden">
                            ...
                            echo $fecha;
                            ?><input name="fecha_esc" value="<?php echo $fecha; ?>" type="hidden">
                            como el Lote número <b> <input name="noloteui" value="<?php echo $noloteui; ?>" type="hidden" > <?php echo $noloteui; ?> </b> de la Manzana <b> <input name="manzana" value="<?php echo $manzana; ?>" type="hidden" > <?php echo $manzana; ?> </b> del Fraccioamiento <b> <input name="fraccionamiento" value="<?php echo $fraccionamiento; ?>" type="hidden" > <?php echo $fraccionamiento; ?> </b>de esta ciudad de Irapuato,Gto.
