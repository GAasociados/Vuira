...
<body>
  ...
  <table style="width:100%; floar:left;">
    ...
    <tr>
      <td style="border: 1px solid black;">TIPO DE AUTORIZACIÓN</td>
      <td style="border: 1px solid black;">No. DE AUTORIZACIÓN</td>
    </tr>
    <tr>
      <td></td>
      <td style="text-align: center;"><?php // XXX:  ?></td>
    </tr>
    <tr>
      <td>Permiso SARE</td>
...
DE FECHA 23 DE DICIEMBRE DEL AÑO 2016; MISMAS QUE ENTRARON EN VIGOR A PARTIR DEL 1o DE ENERO DEL AÑO 2017 PARA EL EJERCICIO FISCAL AÑO 2017.
  ...
  <table style="width:100%; floar:left;">
    ...
    <tr>
      <td colspan="6" style="text-align: right;"><input type="text" name="d11" value="$382.63"></td>
    </tr>
  </table>
  ...
  <table style="width:100%; floar:left;">
    ...
    <tr>
      <td style="border: 1px solid black; text-align: center;"><?php // XXX:  ?>
        <br>
      ...
      <td style="border: 1px solid black; text-align: center;">
        <img src="http://chart.googleapis.com/chart?cht=qr&amp;chs=150x150&amp;chl=<?php echo $arrayDias[date('w')].", ".date('d')." de ".$arrayMeses[date('m')-1]." de ".date('Y');?> -Dirección de Desarrollo Territorial&amp;chld=H|0">
        <br>
