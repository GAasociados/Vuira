                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                        <li class="active">
                                            <a data-toggle="tab" class="step" aria-expanded="true">
                                                ...
                                                <b>Clave Catastral Individual</b>
                                            </a>
                                        </li>
                                    </ul>
                                    <h2 class="block bold">Identificación y Ubicación del Inmueble</h2>
                                                ...
                                                <div class="col-md-12 col-xs-12" >
                                                    ...
                                                    <label><?php echo "Calle: " . $calleui; ?><?php echo $nooficialui != "" ? ", N° Ext " . $nooficialui : ""; ?><?php echo $nooficialui != "" ? ", N° Int " . $nooficialinui : ""; ?><?php
                                                        if (!empty($cbocoloniaui)):
                                                            ...
                                                            <?php echo ucfirst(strtolower($arraycolonia->tipo_de_asentamiento)) . ": " . ucfirst(strtolower($arraycolonia->colonia)); ?>
                                        ...
                                        <div class="row" >
                                            <div class="form-group">
                                                 <div class=" form-group col-md-4 col-xs-12">
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url() . "claves_catastrales_individual/pago/" . $ID; ?>"><i class="fa fa-credit-card"></i> <b>Pago en linea</b></a>
                                                <?php endif; ?>
                                                </div>
                                                <div class=" form-group col-md-4 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $compro; ?>">Descargar Comprobante</a>
                                                    <?php else: ?>
                                                ...
                                                <div class=" form-group col-md-4 col-xs-12">
                                                    <h4 class="bold">Documento para pago</h4>
                                                    <?php if ($doctopago): ?>
                                                        <a href="<?php echo base_url() . "assets/tramites/clavescatastralesfraccionamiento/" . $doctopago; ?>">Descargar Documento</a>
                                                    <?php else: ?>
                                        ...
                                        <div class="row" >
                                            <div class=" form-group col-md-12">
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155) { ?>
                                                    <a href="<?php echo base_url(); ?>claves_catastrales_fraccionamiento" class="btn btn-primary">Regresar</a>
                                                <?php } else { ?>
