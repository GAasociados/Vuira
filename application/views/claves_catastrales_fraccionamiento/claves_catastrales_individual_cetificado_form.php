                                    ...
                                    <form id="formclave" action="<?php echo $action; ?>" method="post" enctype = "multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input  autocomplete="off"   required="" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" type="text" class="form-control"  pattern="[A-Z0-9 ,.-ÑÁÉÍÓÚ]+" name="calleui" id="calleui" placeholder="Calle" value="<?php echo $calleui; ?>" />
                                            </div>

                                            <div class=" col-md-3">
                                                <label for="varchar">Número Exterior *</label>
                                                <input  autocomplete="off"   required="" type="text" class="form-control" pattern="[A-Za-z0-9 -/]+" name="numext" id="numext" placeholder="Número Exterior" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $numext != "" ? $numext : "S/N"; ?>" />
                                            </div>    
                                            <div class=" col-md-2">
                                                <label for="varchar">Número Interior</label>
                                                <input  autocomplete="off"   type="text" class="form-control" name="numint" pattern="[A-Za-z0-9 -/]+" id="numint" placeholder="Número Interior" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $numint; ?>" />
                                            </div> 

                                            <div class="form-group col-md-4">
                                                <label for="int"> Poblado/Localidad/Comunidad/Ejido *<?php echo form_error('cbocomunidad') ?></label>
                                                <input  autocomplete="off"    required type="text" class="form-control" pattern="[A-Za-z0-9 -/.ÑÁÉÍÓÚ]+" name="cbocomunidad" id="cbocomunidad" placeholder="Poblado/Localidad/Comunidad/Ejido" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();"     value="<?php echo $cbocomunidad; ?>" />
                                            </div>
                                        </div>
                                        <div id="paso4">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input autocomplete="off"    type="text" class="form-control" pattern="[A-Za-z0-9 ./-ÑÁÉÍÓÚ]+" name="zonaloteparcela" id="zonaloteparcela" placeholder="Zona/Lote/Parcela" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $zonaloteparcela != "" ? $zonaloteparcela : "S/N"; ?>" />
                                                </div>
                                                <div class="form-group col-md-3">
                                        ...
                                        <div class="row" id="paso6">
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <input  autocomplete="off"  pattern="[A-Z0-9 .,-ÑÁÉÍÓÚ]+"  required type="text" class="form-control"  name="nombrepropietariodp" id="nombrepropietariodp" placeholder="Nombre del Propietario" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $nombrepropietariodp; ?>" />
                                                </div>
                                        ...
                                        <?php if ($this->session->userdata('tipo') == 1555 || $this->session->userdata('tipo') == 155): ?>
                                            <div class="row"> 
                                                <div class="col-md-12">
                                                    <?php if ($imuvii == 1): ?>
                                                        <div class=" form-group col-md-4" >
                                                            <a data-target="#fullimu" data-toggle="modal" class="btn btn-success">Generar Documento IMUVII</a>
                                                        </div>
                                                    <?php else: ?>
                                                        <div class="form-group col-md-4">
                                                            <a data-target="#full" data-toggle="modal" class="btn btn-success">Generar Documento Final</a>
                                                        </div> 
                                                    <?php endif; ?>

                                                    <div class="col-md-4" id="hiddendoctofinal">
                                                        <label for="varchar"> <b>Documento Final *</b> <?php echo form_error('doctofinal') ?></label>
                                                        <input type="file" accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip"  name="doctofinal" id="doctofinal"/>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <a data-target="#fullnega" data-toggle="modal" class="btn btn-success">Generar Documento Negación</a>
                                                    </div>  
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input  autocomplete="off"   required pattern="([0-9]{18})|([0-9]{15})" id="clavenueva" name="clave" placeholder="Clave Catastral" class="form-control" value="<?php echo $clave == "" ? "017" : $clave; ?>" maxlength="18" minlength="15"/>
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input  autocomplete="off"   value="<?php echo $noescri; ?>" maxlength="12"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 .-/]+"  name="no_escritura" placeholder="Númer Titulo o Escritura" value="" class="form-control" value=""/>
                                                                </div>

                                                                <div class="form-group col-md-4">
                                                                    <label for="varchar"> Clave Catastral *</label>
                                                                    <input  autocomplete="off"   required id="clavenueva" name="clave" placeholder="Númer Escritura" class="form-control" value="<?php echo $clave == "" ? "017" : $clave; ?>" maxlength="18" minlength="15"/>
                                                                </div>
                                                                <div class="form-group col-md-4">
        ...
        <?php if ($ID === "") { ?>
            <script>
                ...
                $("#formclave").submit(function (e) {
                    alert("Recuerde : Falsear Información esta penado por la Ley según el artículo 234 del código penal para el estado de Guanajuato.");
    //                e.preventDefauly();
                });
