                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                        <li class="active">
                                            <a data-toggle="tab" class="step" aria-expanded="true">
                                                ...
                                                <b>Realize su pago para el trámite de Autorización de uso de Construcción</b>
                                            </a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="row">
                                            <div  class="form-group" >
                                                ...
                                                <div id="paso8" class="col-md-4 col-xs-12">
                                                    ...
                                                    <label><?php echo $nombrepropietariodg; ?></label>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div  class="form-group" >
                                                <div class="col-md-6 col-xs-12" >
                                                    ...
                                                    <?php 
                                                    $resulta = $this->Colonias_model->getcoloniabyid($coloniadg);
                                        ...
                                        <div class="row" >
                                            <div class="form-group">
                                                ...
                                                <div class=" form-group col-md-6 col-xs-12">
                                                    ...
                                                    <?php if ($docspago): ?>
                                                        <a href="<?php echo base_url() . "assets/tramites/construccion/" . $docspago; ?>">Descargar Documento</a>
                                                    <?php else: ?>
                                         ...
                                         <div class="row" >
                                                <div class=" form-group col-md-4 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url() . "assets/tramites/construccion/" . $compro; ?>">Descargar Comprobante</a>
                                                    <?php else: ?>
                                            ...
                                            <div class=" form-group col-md-2">
                                             ...
                                             <div class=" form-group col-md-2">
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155) { ?>
                                                    <a href="<?php echo base_url(); ?>ocupacion_de_construccion" class="btn btn-primary">Regresar</a>
                                                <?php } else { ?>
                                                    <a href="<?php echo base_url(); ?>ocupacion_de_construccion" class="btn btn-primary">Regresar</a>
                                                <?php } ?>
