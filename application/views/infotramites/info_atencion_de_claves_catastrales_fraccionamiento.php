                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div id="page-title">
                        ...
                        <h3 class="title-hero">Asignación y Certificación de Claves Catastrales (Fraccionamiento)</h3>
                        </div>
                    <hr/>
                    <div class="contenido text-justify">
                      ...
                      <ul>
                          <li>Escritura del predio (que contenga la foja registral)</li>
                          <li>Recibo del predial actualizado general y/o cuentas prediales individuales</li>
                          <li>Identificación (INE,Pasaporte,Cédula Profesional) del propietario y/o representante legal</li>
                          <li>Plano Digital de traza autorizado por la Dirección General de Desarrollo Territorial</li>
                          <li>Oficio de traza autorizado por la Dirección General de Desarrollo Territorial</li>
                          <li>Documento que acredite al representante legal (poder simple, en su caso)</li>
                      </ul>

						<h4><b>Observaciones</b></h4>
						<ul>
							<li>Costo: $<?php echo $costo[0]->costo_tram;?> por predio + $<?php echo $costo[0]->costo_base ;?> base = $<?php echo $costo[0]->costo_tram+ $costo[0]->costo_base?>, por certificación de clave catastral $<?php echo $costo[1]->costo_tram;?> </li>
							<li>Tiempo de respuesta: 5 días hábiles </li>
							<li>Vigencia del servicio: no aplica </li>
						</ul>
                      ...
                      <br>
                      Ley de Ingresos para el Municipio de Irapuato, Gto. para el Ejercicio Fiscal <?php echo date('Y');?>; (Art. 27 inciso VIII)
                      <br>  Ley de Hacienda para los Municipios del estado Guanajuato
                      <br>
                      ...
                      <br>Normas Técnicas de Zonificación
                        <br>
                      <br>
                        <h4><b>Fundamentos Reglamentarios</b></h4>
                      Reglamento Orgánico de la Administración Pública del Municipio de Irapuato, Guanajuato (Artículo 75)
                      <br>
...
if ($this->session->userdata("login")) {
        ...
        //$_SESSION["Tipo"] = $this->session->userdata('tipo'); ?>
                          ...
                          <div class="col-md-12">
                              ...
                              <?php } else { ?>
                                  <a class="btn btn-success mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href="https://vuira.irapuato.gob.mx/VUIRA1.5/c_clave_fraccionamientos/Clave_Catastral_Fraccionamientos_Ventanilla.php">
                          ...
                          <br>
                          <br>
                          <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo')==4 || $this->session->userdata('tipo')==3): ?>
                          ...
                          <a class="btn btn-primary mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('claves_catastrales_fraccionamiento/autorizar'); ?> ">
                                      <span class="ladda-label"><i class="icon-book-open"></i>Trámites a Autorizar </span>
                                      <span class="ladda-spinner"></span>
                                  </a>

                                  <br><?php endif;?>
                                  <?php if ($this->session->userdata('tipo') == 15 && $this->session->userdata('admin') == 2): ?>
                                  <a class="btn btn-primary mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('claves_catastrales_fraccionamiento/validar'); ?> ">
                                      <span class="ladda-label"><i class="icon-book-open"></i>Trámites a Validar </span>
                                      <span class="ladda-spinner"></span>
                                  </a>
                              ...
                              <div class="col-md-12">
                                  ...
                                  <?php if ($this->session->userdata('tipo') == 15 && $this->session->userdata('admin') != 1 && $this->session->userdata('admin') != 2 ):?>
                                    <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href="https://vuira.irapuato.gob.mx/VUIRA1.5/c_clave_fraccionamientos/Clave_Catastral_Listado.php?operation=Ventanilla">
                                  <span class="ladda-label"> <i class="glyph-icon icon-eye"></i> Tramites Ventanilla</span>
                                  <span class="ladda-spinner"></span></a>
                                  <br> <br>
                                  <a class="btn btn-success mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href="https://vuira.irapuato.gob.mx/VUIRA1.5/c_clave_fraccionamientos/Clave_Catastral_Fraccionamientos_Ventanilla.php">
                                      <span class="ladda-label" title="Trámite con Escritura Pública"><i class="glyph-icon icon-check-square-o"></i>Realizar Trámite&nbsp;&nbsp;</span>
                                      <span class="ladda-spinner"></span>
                                  </a>
                                   <br>  <br>
                                   <?php endif;?>
                                  <!--<a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" ">
                        ...
                        <?php endif; ?>
                              ...
                              <div class="col-md-12">
                                   <br>
                                  <a class="btn btn-primary mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href="https://vuira.irapuato.gob.mx/VUIRA1.5/c_clave_fraccionamientos/Clave_Catastral_Listado.php?operation=Asignar">
                                      <span class="ladda-label">Asignar Trámites<i class="icon-book-open"></i></span>
                                      <span class="ladda-spinner"></span></a>
                              </div>
                          ...
                          <?php if ($this->session->userdata('tipo') == 1555 || $this->session->userdata('tipo') == 155): ?>
                              <div class="col-md-12">
                                   <br>
                                  <a class="btn btn-primary mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href="https://vuira.irapuato.gob.mx/VUIRA1.5/c_clave_fraccionamientos/Clave_Catastral_Listado.php?operation=Auxiliar&uid=<?php echo $this->session->userdata('id');?>">
                                      <span class="ladda-label">Ver mis Trámites <i class="icon-book-open"></i></span>
                                      <span class="ladda-spinner"></span></a>
                              </div>
                          <?php endif; ?>

                          <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 1555): ?>
                              <!--<div class="col-md-12">
                                  <br>
                                  <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" claves_catastrales_fraccionamiento/reportes ">
                                      <span class="ladda-label"> Reportes <i class="glyph-icon icon-bar-chart"></i></span>
                                      <span class="ladda-spinner"></span></a>
                              </div>-->
                          <?php endif; ?>
                      <?php } else { ?>
                         <form action="<?php echo base_url()."login";?>" method="post">
                          <br>
                          <br>
                          <input name="redirec" type="hidden" value="/infotramites/info_atencion_de_claves_catastrales_fraccionamiento">
...
<script>
                        ...
                        function iniciarAyuda() {
                            ...
                            var enjoyhint_script_steps = [
                                ...
                                {
                                    "next #paso1": '<br><br><br><br><br><br>Primeramente indique si la persona solicitante es el propietario del predio o no.<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                },
                                {
