                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div id="page-title">
                        ...
                        <h3 class="title-hero">Permiso de Anuncios Autosoportados o en Azoteas </h3>
                    </div>
                    <hr/>
                    <div class="contenido text-justify">
                      ...
                      En el caso de carteleras para anuncios Auto Soportados o en azoteas presentar:
                      <ul>
                          <li>Identificación Oficial del (los) Propietario(s).</li>
                          <li>Permiso de la estructura donde se pretende colocar la publicidad.</li>
                          <li>Propuesta de diseño del anuncio con dimensiones, materiales a utilizar y leyenda a publicitar.</li>
                      </ul>
...
<div id="modal-aviso-privacidad" class="modal fade bs-example-modal-lg in" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
 ...
 <?php if ($this->session->userdata("login")) { ?>
                          ...
                          <div class="col-md-12">
                              ...
                              <?php } else { ?>
                                  <a class="btn btn-success mt-ladda-btn ladda-button btn-circle" data-style="expand-right"href=" <?php echo base_url('/permiso_anuncios/clave'); ?> ">
                          ...
                          <?php if ($this->session->userdata('tipo') == 12 && $this->session->userdata('admin') == 1): ?>
                              <div class="col-md-12">
                                  <br>
                                  <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('/permiso_anuncios/asignacion'); ?> ">
                                      <span class="ladda-label"><i class="glyph-icon icon-eye"></i>Ver Tramites a Asignar</span>
                                      <span class="ladda-spinner"></span></a>
                              </div>
                      <div class="col-md-12">
                                  <br>
                                  <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('/permiso_anuncios/autorizacion'); ?> ">
                                      <span class="ladda-label"><i class="glyph-icon icon-eye"></i>Ver Tramites a Autorizar</span>
                                      <span class="ladda-spinner"></span></a>
                              </div>
                          <?php else: ?>
                              <div class="col-md-12">
                                  <br>
                                  <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('/permiso_anuncios'); ?> ">
                          ...
                          <?php if ($this->session->userdata('tipo') == 12): ?>
                              <div class="col-md-12">
                                  <br>
                                  <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url(); ?>permiso_anuncios/reportes ">
                      ...
                      <?php } else { ?>
                          <form action="<?php echo base_url() . "login"; ?>" method="post">
                              ...
                              <br>
                              <br>
                              <input name="redirec" type="hidden" value="/infotramites/info_permisos_de_anuncios_autosoportados_azoteas">
...
<script>
                        ...
                        function iniciarAyuda() {
                            ...
                            var enjoyhint_script_steps = [
                                ...
                                {
                                    "next #paso1": '<br>Primeramente indique si la persona solicitante es el propietario del predio o no.<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                },
                                {
