...
<button class="btn btn-warning btnAyudaForm" title="Ayuda" id="ayuda" onclick="iniciarAyuda()"> 
    ...
    <body class="page-container-bg-solid">
        ...
        <div class="page-wrapper">
            ...
            <div id="page-content" style="padding: 0; margin-top: 100px;">
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div id="page-title">
                        ...
                        <h3 class="title-hero">Autorización para el Uso y Ocupación de la Construcción</h3>
                    </div>
                    <hr/>
                    <div class="contenido text-justify">
                      ...
                      <br><br>
                        <h4><b>Usuarios</b></h4>
                      Ciudadanos y fraccionadores que hayan concluído los trabajos de construcción dentro de un inmueble de su propiedad.
                      <br><br>
                        <h4><b>Requisitos</b></h4>

                      <ul>
                          <li>Permiso de Construcción</li>
                          <li>Bitácora de obra en la cual se registre el avance de los trabajos ejecutados avalada por el Perito y/o Perito Responsable Especializado en su caso.</li>
                          <li>En caso de existir cambio de proyecto, presentar tres juegos de planos que contengan el diseño arquitectónico, estructural y de instalaciones avalados (sellados y firmados) por el Perito y/o Perito Responsable Especializado en su caso. </li>
                          <li>Reporte fotográfico del inmueble</li>
                      </ul>
                      ...
                      Costo: <?php
                                    ...
                                    <?php endforeach; ?>
                      <br>Tiempo de respuesta: 5 días hábiles
                      <br>Vigencia del servicio: Única<br>
                      <br>
                      ...
                      Código Territorial para el Estado y los Municipios de Guanajuato, Ley de Ingresos para el municipio de Irapuato Guanajuato para el ejercicio fiscal del año <?php echo date('Y'); ?> Art. 26 fracc. XIV y XV.
                      <br>
  ...
  <?php if ($this->session->userdata("login")) { ?>
                          <?php if ($this->session->userdata('tipo') == 4 || $this->session->userdata('tipo') == 3): ?>
                            <div align="center"  class="col-md-12" style="">
                                <a class="btn btn-success" data-style="expand-right" href=" <?php echo base_url('ocupacion_de_construccion/clave'); ?> ">
...
<br>
                            <div align="center"  class="col-md-12" style="">
                                ...
                                <a class="btn btn-info" data-style="expand-right" href=" <?php echo base_url('ocupacion_de_construccion/asignacion'); ?> ">
                                    <span class="ladda-label"><i class="glyph-icon icon-eye"></i>Ver Trámites a Asignar </span>
                                    <span class="ladda-spinner"></span></a>
                            </div>
                            <div align="center"  class="col-md-12" style="">
                        <br>
                                <a class="btn btn-info" data-style="expand-right" href=" <?php echo base_url('ocupacion_de_construccion/autorizacion'); ?> ">
                        ...
                        <div align="center"  class="col-md-12" style="">
                        <br>
                            <a class="btn btn-info" data-style="expand-right" href=" <?php echo base_url('ocupacion_de_construccion'); ?> ">
                        ...
                        <?php if ($this->session->userdata('tipo') == 11 || $this->session->userdata('tipo') == 12): ?>
                            <div align="center"  class="col-md-12" style="">
                            <br>
                                <a class="btn btn-info" data-style="expand-right" href=" <?php echo base_url(); ?>ocupacion_de_construccion/reportes ">
...
<script>
                        ...
                        function iniciarAyuda() {
                            ...
                            var enjoyhint_script_steps = [
                                {
                                    "next #ayuda": 'Aviso de terminación de obra.<br> Para continuar con la ayuda del trámite <br>Presione "Siguiente".',
