                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div id="page-title">
                        ...
                        <h3 class="title-hero">Autorización y Atención de Avaluos Rústicos</h3>
                    </div>
                    <hr/>
                    <div class="contenido text-justify">
                      ...
                      <ul>
                        ...
                        <br>
                        Por avalúos de inmuebles urbanos y suburbanos se cobrará una cuota fija de $79.88 mas 0.90 al millar sobre el valor que arroje el peritaje.
                        ...
                        Cuando un predio rústico contenga construcciones, además de la cuota anterior se aplicará lo que dispone la Fracción I del Artículo 27 de la Ley de Ingresos <?php echo date('Y');?> para el Municipio de Irapuato, Guanajuato para el Ejercicio Fiscal <?php echo date('Y');?> sobre el valor de la construcción sin la cuota fija.
                        <br>
                        
                        Por la validación de avalúos fiscales elaborados por los peritos valuadores autorizados por la Tesorería Municipal, se pagará el 30% sobre la cantidad que resulte de aplicar la fracción I del Artículo 27 de la Ley de Ingresos <?php echo date('Y');?> para el Municipio de Irapuato, Guanajuato para el Ejercicio Fiscal <?php echo date('Y');?> sobre el valor de la construcción sin la cuota fija.
...
<br>
                      ...
                      <br>
                        ...
                        Reglamento Orgánico de la Administración Pública  Municipal de Irapuato, Guanajuato Articulo 75.
                        <br>
       ...
       <?php if ($this->session->userdata("login")) { ?>
                        ...
                        <?php endif; ?>
                          ...
                          <div align="center"  class="col-md-12" style="margin-top: 30px;">
                                <a class="btn btn-success mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url('avaluos_rusticos/create'); ?> ">
                                    <span class="ladda-label"><i class="glyph-icon icon-play"></i>Realizar Trámite&nbsp;&nbsp;</span>
                                    <span class="ladda-spinner"></span></a>
                            </div>
                      
                        <div align="center"  class="col-md-12" style="margin-top: 30px;">
                                       <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url()."avaluos_rusticos"; ?> ">
                        ...
                        <?php if ($this->session->userdata('tipo') == 14): ?>
                            <div align="center"  class="col-md-12" style="margin-top: 30px;">
                                ...
                                <a class="btn btn-info mt-ladda-btn ladda-button btn-circle" data-style="expand-right" href=" <?php echo base_url(); ?>avaluos_rusticos/reportes ">
...
<script>
                        ...
                        function iniciarAyuda() {
                            ...
                            var enjoyhint_script_steps = [
                                {
                                    "next #ayuda": 'Avaluos rusticos.<br> Para continuar con la ayuda del trámite <br>Presione "Siguiente".',
