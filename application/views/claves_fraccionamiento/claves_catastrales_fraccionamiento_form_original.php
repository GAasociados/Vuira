                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group col-md-4" id="paso2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input style="text-transform:uppercase;" ng-model="ctapredial" onkeyup="javascript:this.value = this.value.toUpperCase();"  type="text" pattern="[a-zA-Z0-9]+" class="form-control" name="predialui"  placeholder="Cuenta Predial " maxlength="12"/>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr ng-repeat="pagos in registro" >
                                                            ...
                                                            <td> {{pagos.lote}}  <input type="hidden" name="registro[{{$index}}][noloteui]" value="{{pagos.lote}}"></td>
                                                            <td>  {{pagos.manzana}} <input type="hidden" name="registro[{{$index}}][nomanzanaui]" value="{{pagos.manzana}}"></td>
                            ...
                            success: function (respuesta) {
                                if (respuesta) {
                                    ...
                                    if (propietario == "") {
                                        ...
                                        $("#nombrepropietariodp").val('' + nobreprop);
                                    }
