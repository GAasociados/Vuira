                                    ...
                                    <form action="<?php echo $action; ?>" method="post" enctype = "multipart/form-data">
                                        ...
                                        <div class="row" ng-controller="FraccionaminetoApp" > 
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input readonly="" type="text" class="form-control"  placeholder="Número de control" name="numerocontrol" id="numerocontrol" ng-model="nocontrol"  value="<?php echo $numerocontrol ?>"/>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="varchar">Cantidad de Claves a Generar</label>
                                                        <input readonly="" type="number" class="form-control" required="" min="1" placeholder="Total de Claves" name="cantidad" id="cantidadporpago"  max='999' ng-model="cantclaves"   value="<?php echo $cantidad ?>"/>
                                                    </div>
                                                </div>
                                               ...
                                               <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr ng-repeat="pagos in registro" >
                                                            ...
                                                            <td><a target="_blank" href="<?php echo base_url('claves_catastrales_fraccionamiento/update/')?>{{pagos.id}}" title="" class="btn btn-outline btn-circle btn-sm green ">
                                        ...
                                        <div class="row" id="paso10">
                                            ...
                                            <div class="form-group col-md-6" id="hiddendoctopago">
                                                ...
                                                <input type="hidden" id="divestatus" name="status" value="<?php echo $status; ?>">
                                        </div>
        ...
        <script>
                                                        $(document).ready(function () {
                                                            ...
                                                            if (dato == 4 || dato == 6) {
                                                                ...
                                                                $("#doctopago").prop("required", true);
                                                            } else {
                                                                $("#hiddendoctopago").hide();
                                                                $("#doctopago").prop("required", false);
                                                            }
