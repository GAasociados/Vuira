                                        ...
                                        <div class="row" >
                                            <div class="form-group">
                                                ...
                                                <div class=" form-group col-md-6 col-xs-12">
                                                    ...
                                                    <?php if ($doctopago): ?>
                                                        <a href="<?php echo base_url() . "assets/tramites/permisosanunciosautosoportados/" . $doctopago; ?>">Descargar Documento</a>
                                                    <?php else: ?>
                                         ...
                                         <div class="row" >
                                                <div class=" form-group col-md-4 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url() . "assets/tramites/permisosanunciosautosoportados/" . $compro; ?>">Descargar Comprobante</a>
                                                    <?php else: ?>
                                            ...
                                            <div class=" form-group col-md-2">
                                             ...
                                             <div class=" form-group col-md-2">
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155) { ?>
                                                    <a href="<?php echo base_url(); ?>permiso_anuncios" class="btn btn-primary">Cancelar</a>
                                                <?php } else { ?>
                                                    <a href="<?php echo base_url(); ?>permiso_anuncios" class="btn btn-primary">Cancelar</a>
                                                <?php } ?>
