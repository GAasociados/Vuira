...
<html lang="es">
                            ...
                            <div class="page-content">
                                <div class="container-fluid">
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                      ...
                                      <button type="button" id="asignar" class="btn btn-primary">Asignar Funcionario</button>
                                        ...
                                        foreach ($permiso_anuncios_data as $permiso_anuncios) {
                                            ?>
                                                ...
                                                <tr class="note note-warning">
                                                    <td> <input type="checkbox" id="seleccionar[<?php echo $i; ?>]" name="opc" value="<?php echo $permiso_anuncios->ID; ?>"></td>
    ...
    <script type="text/javascript">
         ...
         <div class="modal fade bs-modal-md" id="small" tabindex="-1" role="dialog" aria-hidden="true">
            <form action="<?php echo base_url() . "permiso_anuncios/asignar_func"; ?>" method="post" >
