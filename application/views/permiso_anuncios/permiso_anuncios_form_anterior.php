...
<html lang="es"  ng-app="Aplicacion">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Permiso de Anuncios Autosoportados</title>
    ...
    <body class="page-container-bg-solid">
                                        ...
                                        <div class="row" id="paso1" >
                                            <div class="form-group">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input   <?php echo $modificar; ?> required placeholder="Clave Catastral" type="text" class="form-control" name="clavecat" id="clavecat"  value="<?php echo $clavecat; ?>" />
                                                </div>                                                
                                                <div class="form-group col-md-3">
        ...
        <!--                                                        <input type="file" multiple name="doctoverificador[]" id="doctoverificador"/>-->
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <button type="submit" id="solicitar"  data-loading-text="<i class='fa fa-spinner fa-spin '></i> Solicitando Trámite" class="btn btn-primary"><?php echo $button ?></button>
                                                ...
                                                <?php endif; ?>
                                                <?php if ($this->session->userdata('tipo') == 12 || $this->session->userdata('tipo') == 122) { ?>
                                                    <a href="<?php echo base_url(); ?>permiso_anuncios" class="btn btn-danger">Regresar</a>
                                                <?php } else { ?>
                                                    <a href="<?php echo base_url(); ?>infotramites/info_permisos_de_anuncios_autosoportados_azoteas" class="btn btn-danger">Regresar</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </form>
...
<?php endif; ?>
            ...
            {
            "next #paso0": 'Para comenzar el trámite por favor indique que si su solicitud es para renovación de permiso.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            },
            {
            "next #paso1": 'Por favor complete la siguiente información general del solicitante.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso2": 'Continuando con el llenada de información por favor complete los siguiente campos.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso3": 'Por favor ingrese los datos generales del inmueble donde se colocara el anuncio.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso4": 'Continuando con el llenado de los dato del inmueble por favor ingrese la siguiente información.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso5": 'Por favor ingrese los datos generales del anuncio como lo son número de carteleras y altura del anuncio.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso6": 'Por favor ingrese la descripción de las dimensiones de las carteleras, así como el total de mts<sub>2</sub> del anuncio y una descripción hacia que será referente el anuncio.<br>De click en "Siguiente" para continuar..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso7": '<span style="color:black;" >Verifique que el mapa indique la posición donde está colocado su anuncio, en caso de no se asi por favor mueva el puntero rojo a la localización de su anuncio.<br>De click en "Siguiente" para continuar..</span>',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso8": '<span style="" >Al iniciar el trámite indico un perito especializado .<br>De click en "Siguiente" para continuar..</span>',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso9": 'Por favor ingrese los siguientes documentos escaneados de los documentos originales.<br>De click en "Finalizar" para concluir el tutorial..',
                    "nextButton": {text: "Siguiente"},
                    "skipButton": {text: "Saltar Guía"}
            }
            ,
            {
            "next #paso10": 'Cuando usted haya capturado todos los datos solicitados de click en Solicitar Trámite,<br> a continuación se guardaran los datos capturados <br>y se notificará via correo electrónico cualquier actualización del trámite.<br>De click en "Finalizar" para concluir el tutorial..',
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group  col-md-12">
                                                        <label><b>Antecedentes del anuncio</b></label>
                                                    </div><br>
                                                    <div class="form-group  col-md-12"><label>Antecedente</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group input-medium date date-picker" data-date-start-date="" data-date-format="dd-mm-yyyy">
                                                            <input class="form-control" ng-model="NuevoComentario.fecha" placeholder="Fecha"  type="text" name="fecha_exp"><span class="input-group-btn">
                                                                <button class="btn btn-primary btn-outline" type="button">
                                                                    <i class="fa fa-calendar"></i>
                                                                </button>
                                                        </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <a class="btn btn-primary" ng-click="Agregar()">Agregar
                                                        </a>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                            ...
                                            <td>
                                                ...
                                                <div class="form-group  col-md-12" ng-repeat="names in name">
                                                    ...
                                                    <a class="remove pull-right" ng-click="removeAngtecedentes(names)"><i class="fa fa-close"></i></a></a>
                                            ...
                                            <td>
                                                <div class="form-group {{otroant ==1 ? '': 'hidden'}}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Fecha </label>
                                                        <div class="input-group input-medium date date-picker" data-date-start-date="" data-date-format="dd-mm-yyyy">
                                                            <input class="form-control" placeholder="Fecha"  type="text" ng-model="NuevoComentario1.fecha" name="fecha_expa" ><span class="input-group-btn">
                                                                <button class="btn btn-primary btn-outline" type="button">
                                                                    <i class="fa fa-calendar"></i>
                                                                </button>
                                                        </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <a class="btn btn-primary" ng-click="Agregarotro()">Agregar
                                                        </a>
                                                    </div>
                                        ...
                                        <tr>
                                            <td colspan="">
                                                ...
                                                <select required="" class="multiple" name="" ng-model="montaje" multiple>
                                            ...
                                            <td>
                                                <label>Caracteristicas de Montaje ("para seleccionar varios Mantener presionado CTRL y  dar click sobre la opción a seleccionar")</label>
                                                <select required class="multiple" name="d14" ng-model="constitucion" multiple>
