        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Reporte Permiso de Anuncios Auto Soportados</h2><br>
      ...
      <!-- BEGIN PAGE CONTENT INNER -->
               <form class="" action=" <?php echo base_url('permiso_anuncios/reportefinal'); ?>" method="post">
                 <div class="form-group col-md-12">
					...
					<div class="form-group col-md-3">
                     ...
                     <label for="date">Fecha de Inicio<?php echo form_error('fechainicio') ?></label>
                      <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
                         <input class="form-control" required type="text" readonly="" name="fechainicio" id="fechainicio" value="" >
                   ...
                   <div class="form-group col-md-3">
                     <br>
                     <label for="date">Fecha Final<?php echo form_error('fechafinal') ?></label>
                      <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
                         <input class="form-control" required type="text" readonly="" name="fechafinal" id="fechafinal" value="" >
						 <span class="input-group-btn">
                           <button class="btn btn-primary btn-outline" type="button">
                             <i class="fa fa-calendar"></i>
                           </button>
