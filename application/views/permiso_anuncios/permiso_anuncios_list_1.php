        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Permiso de Anuncios Auto Soportados Autorización</h2><br>
...
<!--                                                Mis Trámites-->
            ...
            ?>
                                                        ...
                                                        <td style="text-align:center" width="200px">
                                                            <?php
                                                            echo anchor(site_url('permiso_anuncios/update_autorizacion/' . $permiso_anuncios->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-eye"></i> Ver Tramite</button>');
                                                            ?>
                                                        </td>
