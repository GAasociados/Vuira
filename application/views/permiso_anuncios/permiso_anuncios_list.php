...
<!--                    <button class="btn btn-warning float btnAyudaForm" title="Ayuda" id="ayuda" onclick="iniciarAyuda()">
           ...
           <div class="clearfix"></div>
            <div id="page-content">
                <div class="container">
                       <div class="row">
                        <h2>Mis Permiso de Anuncios Autosoportados</h2><br>
                    </div>
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 10px">
                                        ...
                                        foreach ($permiso_anuncios_data as $permiso_anuncios) {
                                            ...
                                            <?php if ($this->session->userdata('tipo') == 12 || $this->session->userdata('tipo') == 122 || $this->session->userdata('tipo') == 16 || $this->session->userdata('tipo') == 166) { ?>
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 12 || $this->session->userdata('tipo') == 122) { ?>
                                                    <?php if ($permiso_anuncios->notificacion == 1 ||$permiso_anuncios->notificacion == 2) { ?>
                                                        ...
                                                        <td style="text-align:center" width="200px">
                                                            <?php
                                                            if ($permiso_anuncios->status == 4 && $permiso_anuncios->autorizacion == 1):
                                                                echo anchor(site_url('permiso_anuncios/update/' . $permiso_anuncios->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                                                            elseif ($permiso_anuncios->status == 4 && $permiso_anuncios->autorizacion == 0):
                                                            else:
                                                                echo anchor(site_url('permiso_anuncios/update/' . $permiso_anuncios->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                                                            endif;
                                                    ...
                                                    <?php } else { ?>
                                                        <?php if ($permiso_anuncios->verificador == $this->session->userdata('id')) { ?>
                                                            ...
                                                            <td><?php echo $permiso_anuncios->nocontrol; ?></td>
                                                            <td>
                                                                <a href="../../../../../../Users/DesarrolladorGA/Documents/Conceptospagos.csv"></a>
                                                                <?php
                                                                if (empty($permiso_anuncios->doctofinal)) {
                                                                    echo "El Documento Final Se Subirá Cuando " .
                                                                    "El Proceso Del Trámite Esté Terminado";
                                                ...
                                                <?php } else { ?>
                                                    <?php if ($permiso_anuncios->usuarioID == $this->session->userdata('id')): ?>
                                                        <?php if ($permiso_anuncios->notificacion == 0) { ?>
                                                        <tr class="note note-warning">
                                                        <?php } else { ?>
                                                        <tr>
                                                        <?php } ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (empty($permiso_anuncios->doctofinal)) {
                                                                ...
                                                                if ($permiso_anuncios->autorizacion != 1 && $permiso_anuncios->status != 6):
                                                                    echo "El Documento Final Se Subirá Cuando " .
                                                                    "El Proceso Del Trámite Esté Terminado";
                                                                else:
                                                                    if ($permiso_anuncios->status == 6 && $permiso_anuncios->autorizacion == 1 && $permiso_anuncios->valido_pago == 1):
                                                                        echo "<a href='" . base_url() . "assets/tramites/permisosanunciosautosoportados/" . $permiso_anuncios->doctofinal . "'>Descargar<a>";
                                                                    else:
                                                                        echo "El Documento Final Se Subirá Cuando " .
                                                                        "El Proceso Del Trámite Esté Terminado";
                                                        ...
                                                        <td style="text-align:center" width="200px">
                                                            <?php
                                                            if ($permiso_anuncios->status < 4):
                                                                echo anchor(site_url('permiso_anuncios/update/' . $permiso_anuncios->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                                                            elseif ($permiso_anuncios->status == 4 && $permiso_anuncios->autorizacion == 1):
                                                                echo anchor(site_url('permiso_anuncios/realizarpago/' . $permiso_anuncios->ID), '<button class="btn btn-success"><i class=""></i>Realizar Pago</button>');
                                                            elseif ($permiso_anuncios->status == 4 && $permiso_anuncios->autorizacion == 0):

                                                            elseif ($permiso_anuncios->status == 6 && $permiso_anuncios->autorizacion == 1 && $permiso_anuncios->valido_pago == 1):
                                                                echo "<a href='" . base_url() . "assets/tramites/permisosanunciosautosoportados/" . $permiso_anuncios->doctofinal . "'>Descargar<a>";
                                                            endif;
                                                            ?>
                                                        </td>
