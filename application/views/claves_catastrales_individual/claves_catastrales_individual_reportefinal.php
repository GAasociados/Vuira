        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                <div class="container">
                    ...
                    <h2>Resultados Reporte Catastrales Individual</h2><br>
...
<!--                                                Reportes-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <a href="<?php echo base_url(); ?>claves_catastrales_individual/" class="btn btn-danger glyph-icon icon-times">Cancelar Búsqueda</a>
                                        </div>
                                        <div class="col-md-2">
                                            <form target="_blank" action="<?php echo base_url(); ?>claves_catastrales_individual/reportespdf" method="POST">
                                                <input name="q" type="hidden" value="<?php echo $seguimiento; ?>">
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 10px">
                                        ...
                                        foreach ($claves_catastrales_individual_data as $claves_catastrales_individual) {
                                            //var_dump($claves_catastrales_individual);
                                            if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 1555) {
                                                ?>
                                                <tr>
                                                    <td>
                                                        <?php
                                                        echo $claves_catastrales_individual->numerocontrol;
                                                        ?>
                                                    </td>

                                                    <td>
                                                        <?php
                                                        if ($claves_catastrales_individual->fechainicio == "0000-00-00") {
                                                            echo "El trámite aún no ha Iniciado";
                                                        } else {
                                                            echo $claves_catastrales_individual->fechainicio;
                                                        }
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if ($claves_catastrales_individual->fechafinal == "0000-00-00") {
                                                            echo "El trámite aún no ha finalizado";
                                                        } else {
                                                            echo $claves_catastrales_individual->fechafinal;
                                                        }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($claves_catastrales_individual->tipotramite == 1):
                                                            ...
                                                            echo anchor(site_url('claves_catastrales_individual/read/' . $claves_catastrales_individual->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');
                                                        else:
                                                            echo anchor(site_url('claves_catastrales_individual_cetificado/read/' . $claves_catastrales_individual->ID), '<button class="btn btn-info"><i class=" glyph-icon icon-refresh"></i> Actualizar</button>');

                                                        endif;
                                                        ?>
                                                        <!--<button class="btn btn-success"><i class="fas fa-arrow-down"></i></i> Descargar pdf</button>-->
                                                    </td>
                                                </tr>
                                                <?php
                                            }
