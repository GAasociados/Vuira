                                    ...
                                    <div class='portlet box blue'>
                                      <div class='portlet-title'>
                                        <div class='caption'>
                                          ...
                                          Trámites pendiente de validación
                                        </div>
                                      <div class='tools'>
                                      </div>
                                    </div>
...
//                                            
                                             ...
                                             <td style="text-align:center" width="200px">
                                               ...
                                               echo anchor(site_url('claves_catastrales_individual/validar_tram/'.$claves_catastrales_individual->ID),'Validar');
                                               else:
                                                      echo anchor(site_url('claves_catastrales_individual_cetificado/validar_tram/'.$claves_catastrales_individual->ID),'Validar');
                                               endif;
                                               ?>
                                             </td>
                                              </tr>
