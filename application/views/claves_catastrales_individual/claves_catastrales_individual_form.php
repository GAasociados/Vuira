...
<div class="page-wrapper">
	...
	echo $modificar;
	echo "<br>".$modificar1;
	echo "<br>".$this->session->userdata('tipo') */
    ?>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <form id="formclave" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div id="generartalon" class="form-group col-md-4">
                                        <a ID="4" target="_blank" class="btn btn-primary btn-lg"
                                           href="<?php echo base_url('claves_catastrales_individual/vistapa/' . $ID) ?>"><i
                                            ...
                                            <div class="form-group" id="datosps">
                                                ...
                                                <div id="fisrfc" class="col-md-12">
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php if ($modificar == ""): ?>
                                                            <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" class=""
                                                                   type="file" name="fisrfc">
                                                        <?php endif; ?> <br>
                                                        <?php if (!empty($fisrfc)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $fisrfc; ?>">Visualizar
                                                                Documento</a>
                                                        <?php endif; ?>
                                                        <br>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php if ($modificar == ""): ?>
                                                            <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" class=""
                                                                   type="file" name="acta_const" value="">
                                                        <?php endif; ?> <br>
                                                        <?php if (!empty($acta_const)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $acta_const; ?>">Visualizar
                                                                Documento</a>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php if ($modificar == ""): ?>
                                                            <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" class=""
                                                                   type="file" name="poder_nota" value="">
                                                        <?php endif; ?>
                                                        <br>
                                                        <?php if (!empty($poder_nota)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $poder_nota; ?>">Visualizar
                                                                Documento</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php if (!empty($morine)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $morine; ?>">Visualizar
                                                                Documento</a>
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-4" id="paso13">
                                                    <label for="varchar">Documento legal que acredite la propiedad;
                                                        ...
                                                        archivos*<?php echo form_error('doctolegalpropiedad') ?></label>
                                                    <?php if ($modificar == ""): ?>
                                                        <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" type="file"
                                                               accept="application/pdf, image/*"
                                                               name="doctolegalpropiedad[]" multiple=""
                                                               id="doctolegalpropiedad"
                                                    ...
                                                    <?php if (!empty($doctolegalpropiedad)): ?>
                                                        <a target="_blank"
                                                           href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $doctolegalpropiedad; ?>">Visualizar
                                                            Documento</a>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <?php if (empty($rpredial)): ?>
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <?php if ($modificar == ""): ?>
                                                            <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip"
                                                                   type="file" name="doctopredial" id="doctopredial"
                                                                   placeholder="Recibo impuesto predial"/>
                                                        <?php endif; ?>

                                                        <?php if (!empty($doctopredial)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $doctopredial; ?>">Visualizar
                                                                Documento</a>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <div id="paso3">
                                                <label for="varchar">Número Cuenta
                                                    Predial*<?php echo form_error('predialui') ?></label>
                                                <input <?php echo $modificar1; ?>
                                                        title="Este Número se compone de 12 Digitos o la palabra APERTURA si no se cuenta con un número predial"
                                                        style="text-transform:uppercase;"
                                                        autocomplete="off" required="" type="text" pattern="[A-Z0-9]+"
                                                        class="form-control" name="predialui" id="predialui"
                                                        placeholder="Cuenta Predial" value="<?php echo $predialui; ?>"
                                                        maxlength="12" onfocusout="clavesGeneradas();"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <div id="paso2">
                                                <label for="int">Categoría del Predio
                                                    *<?php echo form_error('categoriapredioui') ?></label>

                                                <select <?php echo $modificar1; ?> required class="form-control"
                                                                                   name="categoriapredioui"
                                                                                   tabindex="-1" id="categoriapredioui"
                                                                                   value="<?php echo $categoriapredioui; ?>">
                                        ...
                                        <div class="col-md-6" id="paso4">
                                            <div class=" col-md-6 ">
                                                ...
                                                <input <?php echo $modificar1; ?> autocomplete="off"
                                                                                  style="text-transform:uppercase;"
                                                                                  required type="text"
                                                                                  class="form-control" name="calleui"
                                                                                  id="calleui" placeholder="Calle"
                                        ...
                                        <div class="form-group">
                                            <div class=" col-md-3">
                                                <label for="varchar">Número Exterior
                                                    *<?php echo form_error('nooficialui') ?></label>
                                                <input <?php echo $modificar1; ?> autocomplete="off" required
                                                                                  type="text"
                                                                                  style="text-transform:uppercase;"
                                                                                  pattern="[A-Za-z0-9  -/�?É�?ÓÚÑ]+"
                                                                                  class="form-control"
                                                                                  name="nooficialui" id="nooficialui"
                                                                                  placeholder="Número Exterior"
                                                                                  value="<?php echo $nooficialui != "" ? $nooficialui : "S/N"; ?>"/>
                                            </div>
                                            <div class="form-group col-md-3 ">
                                                <label for="varchar">Número Interior</label>
                                                <input <?php echo $modificar1; ?> autocomplete="off" type="text"
                                                                                  class="form-control"
                                                                                  style="text-transform:uppercase;"
                                                                                  pattern="[A-Za-z0-9 -/�?É�?ÓÚÑ]+"
                                                                                  name="nooficialinui"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input <?php echo $modificar1; ?> autocomplete="off" type="text"
                                                                                  ...
                                                                                  pattern="L-[0-9A-Z -/]+"
                                                                                  class="form-control" name="noloteui"
                                                                                  id="noloteui"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input <?php echo $modificar1; ?> autocomplete="off" type="text"
                                                                                  pattern="M-[0-9A-Z  -/]+"
                                                                                  title="El formato de este campo es (M-Número)"
                                                                                  style="text-transform:uppercase;"
                                                                                  class="form-control"
                                                                                  name="nomanzanaui" id="nomanzanaui"
                                                                                  placeholder="Manzana"
                                        ...
                                        <div class="form-group">
                                            <div id="coloniauno" class="form-group col-md-6 hidden">
                                                <label for="int"> Fracc/Condominio/Colonia/Barrio/Comunidad/Predio/Ejido
                                                    *<?php echo form_error('cbocoloniaui') ?></label>
                                                <?php if ($modificar1 == ""): ?>

                                                    <select class="form-control select2" required=""
                                                            title="Indica tu colonia" tabindex="-1" name="cbocoloniaui"
                                                            tabindex="-1" id="cbocoloniaui">
                                                        <?php
                                                        if ($cbocoloniaui != ""):
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    if ($cbocoloniaui != ""):
                                                        ...
                                                        <input class="form-control" <?php echo $modificar1; ?>
                                                               value="<?php echo strtoupper($arraycolonia->NOMBRE); ?>">
                                                        <input id="cbocoloniaui" type="hidden"
                                                               value="<?php echo $arraycolonia->COLONIA_ID; ?>">
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                         </div>
										   <div id="coloniados" class="form-group col-md-5 hidden">
                                                <label for="int">Fracc/Condominio/Colonia/Barrio/Comunidad/Predio/Ejido
                                                    *<?php echo form_error('cbocoloniaui') ?></label>
                                                <input <?php echo $modificar1; ?>
                                                        autocomplete="off" <?php echo $coloniados != "" ? "required" : ""; ?>
                                                        style="text-transform:uppercase;"
                                                        type="text" pattern="[A-Za-z0-9  �?É�?ÓÚÑ-/]+" id="colonia2"
                                                        name="colonia2"
                                                        placeholder="Fracc/Condominio/Colonia/Barrio/Comunidad/Predio/Ejido "
                                                        class="form-control" value="<?php echo $coloniados; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="paso7">
                                        <div class="form-group">
                                            <div class="form-group col-md-12">
                                                ...
                                                <?php } else { ?>
                                                    <input id="address" type="hidden" class="form-control"
                                                           value="Uruapan,Michoacan." name="mapa">
                                                <?php } ?>
                                                <!--
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <h4>
                                                        En caso de que la ubicación mostrada en el mapa no coincida con
                                                        la dirección capturada,
                                                        usted puede mover el punto de ubicación color rojo al lugar
                                                        deseado.
                                                    </h4>
                                                    <style>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div id="paso8" class="col-md-6">
                                                <label for="varchar">Nombre del Propietario o Razón Social
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                ...
                                                <input <?php echo $modificar; ?> required type="email"
                                                                                 ...
                                                                                 value="<?php echo $correonotificacionesdp != "" ? $correonotificacionesdp : $this->session->userdata('correo'); ?>"/>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="varchar">Teléfono
                                                    *<?php echo form_error('telefononotificacionesdp') ?></label>
                                                <input <?php echo $modificar; ?> maxlength="10" pattern="[0-9]{7,10}"
                                                                                 required type="text"
                                                                                 class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6" id="paso11a">
                                                ...
                                                <select <?php echo $modificar; ?> required class="form-control"
                                                                                  name="motivotramitedp" tabindex="-1"
                                                                                  id="motivotramitedp"
                        ...
                        <!--<div class="row content-box border-top border-blue <?php echo $this->session->userdata('tipo') == 15? "hidden" : true ?>">
                            <div class="content-box-wrapper">
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                        <?php if ($modificar == ""): ?>
                                            <h4 class="block">IV. Adjunte los Siguientes Archivos en Original</h4>
                                        <?php else: ?>
                                    ...
                                    <div class="row" id=paso12>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div id="otrosdoc"
                                                    ...
                                                    <label for="varchar">Adjuntar otra documentación (Si son varios
                                                        archivo por favor adjuntar un archivo
                                                        .rar)*<?php echo form_error('otradoc') ?></label>
                                                    <?php if ($modificar == ""): ?>
                                                        <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" type="file"
                                                               multiple name="otradoc" id="otrodoc" placeholder=""/>
                                                    <?php endif; ?>
                                                    <?php if (!empty($otradoc)): ?>
                                                        <a target="_blank"
                                                           href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $otradoc; ?>">Visualizar
                                                            Documento</a>
                                                    <?php endif; ?>
                                                </div>

                                                <div id="mdocaux1"
                                                     class="form-group col-md-4  <?php echo $mdocaux1 == 0 ? "hidden" : ' ' ?>">
                                                    <label for="varchar">Adjuntar otra documentación (Si son varios
                                                        archivo por favor adjuntar un archivo .rar)*</label>
                                                    <?php if ($modificar == ""): ?>
                                                        <input accept=".jpg, .jpeg, .png ,.pdf, .rar, .zip" type="file"
                                                               multiple name="mdocaux1" id="mdocaux1" placeholder=""/>
                                                    <?php endif; ?>
                                                    <?php if (!empty($mdocaux1)): ?>
                                                        <a target="_blank"
                                                           href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $mdocaux; ?>">Visualizar
                                                            Documento</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <?php if ($valido_pago == 1): ?>
                                                <div class="col-md-12">
                                                    <h5 class="note note-success  bold"
                                                        style=" background-color:rgba(0,255,0,0.3); ">El Trámite ya ha
                                                        sido pagado.</h5>
                                        ...
                                        <?php if ($this->session->userdata('tipo') == 14555): ?>
                                            <div class="form-group col-md-12" id="hiddendoctopago">
                                                <div class="form-group col-md-6">
                                                    <?php if (!empty($status)): ?>
                                                        ...
                                                        <?php if (!empty($doctopago)): ?>
                                                            <a target="_blank"
                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $doctopago; ?>">Descargar</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <?php if (!empty($compro)): ?>
                                                        <label for="varchar" id="parpadear"> <b>Comprobante de pago </b>
                                                        </label>
                                                        <br>
                                                        <a target="_blank"
                                                           href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $compro; ?>">Descargar</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label> <b>Si el ciudadano requiere presentar mas documentación por favor seleccione la
                                        casilla <?php echo form_error('otros_doc') ?></b> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="checkbox"
                                               name="imuvii" <?php echo $imuvii == 1 ? "checked" : ""; ?>
                                               value="<?php echo $imuvii; ?>">
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <?php if ($this->session->userdata('tipo') == 1555 || $this->session->userdata('tipo') == 155): ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <select name="Tipo_Tramite" id="cmbtipodocumento2" class="form-control" onchange="getTipoDocumento(this);">
                                            <option value="">Favor de elegir una opci&oacute;n</option>
                                            <option value="Solicitud IMUVII">Solicitud IMUVII</option>
                                            <option value="Constancia Ejidal">Constancia Ejidal</option>
                                            <option value="Escritura Publica">Escritura pública</option>
                                            <option value="INFONAVIT">INFONAVIT</option>
                                            <option value="CORETT">CORETT</option>
                                            <option value="Titulo de Propiedad">Título de propiedad</option>
                                            <option value="Sentencia Juridica">Sentencia Juridica</option>
                                    ...
                                    <script>
                                        $('#cmbtipodocumento2').change(function(){
                                            $('#tipotramite').val($(this).val());
                                        });
                                    </script>

                                    <!--div class="form-group col-md-12">
                                        <label class="bold" for="tinyint">Solicitud IMUVII</label>
                                        <input type="checkbox" name="imuvii"
                                               id="cambiardoc" <?php //echo $imuvii == 1 ? "checked" : ""; ?>
                                               value="<?php //echo $imuvii; ?>">
                                    </div-->
                                    <div class="form-group col-md-12"></div>
                                    <div class="form-group col-sm-6">
                                        <a class="btn btn-success "
                                           id="docnormal"><b>Generar Documento Final</b></a>
                                        <a data-target="#fullimu" data-toggle="modal" class="btn btn-success"
                                           id="docimuvii"><b>Generar Documento IMUVII</b></a>
                                    </div>
                                    <script>
                                ...
                                <div class="row">
                                    <div class=" form-group col-sm-6">
                                        <label for="varchar"> <b>Documento
                                                .DWG </b> <strong><?php echo form_error('doctofinal') ?></strong></label>
                                        <input type="file" accept=".dwg" name="doctofinal" id="doctofinal"/>
                                        <?php if (!empty($doctofinal)): ?><br>
                                            <a target="_blank" id="docto_dwg"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <a class="btn btn-primary" target="_blank"
                                           href="<?php echo base_url(); ?>docstramites/documentoanuncio/documentopagoindividual/<?php echo $ID; ?>"><b>Documento
                                                de Orden Pago</b></a>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <?php if (!empty($status)): ?>
                            ...
                            <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 1555): ?>
                                <div class="row">
                                    ...
                                    <textarea class="form-control" rows="3" name="mensaje" id="mensaje" style="width:90%; margin-left:20px;"
                            ...
                            <div class="button-group pull float">
                                ...
                                <button class="btn btn-success glyph-icon icon-check-square-o" id="Realizar_Tramite" type="button" onclick="avanzarTramite()">Realizar tr&aacute;mite</button>
                                    ...
                                    <script>
                                        ...
                                        $('#docnormal').on('click',function(){
                                            if($('#cmbtipodocumento2').val()==""){
                                                alert('seleccione una opcion de documento');
                                            }
                                            else{
                                                if($('#cmbtipodocumento2').val()=="Solicitud IMUVII"){
                                                ...
                                                else if($('#cmbtipodocumento2').val()=="Titulo de Propiedad"){
                                                    $('.prop').each(function(){
                                                        $(this).removeClass('hidden');
                                                    });
                                                ...
                                                else if($('#cmbtipodocumento2').val()=="Certificado Parcelario"){
                                                    $('.parce').each(function(){
                                                        $(this).removeClass('hidden');
                                                    });
                                                ...
                                                $('#asunto').val($('#tipotramitedp').val());
                                                $('#pred').val($('#predialui').val());

                                                //$('#full').on('show.bs.modal',function(){
                                                    $.ajax({
                                                    url: "../copropsfull",
                                                    data: {predial: "" + $('#predialui').val()},
                                                    type: "POST",
                                                    dataType: 'json',
                        ...
                        <div class="modal fade" id="fullimu" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form target="_blank"
                                          action="<?php echo base_url(); ?>docstramites/Documentoclave/documentoimuvii_vista"
                                          method="post">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <?php if ($otradoc): ?>
                                                                            <a class="btn btn-primary"
                                                                               ...
                                                                               target="_blank"
                                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $otradoc; ?>"><i
                                                                        ...
                                                                        <?php if ($mdocaux1): ?>
                                                                            <a class="btn btn-primary"
                                                                               style="margin-bottom: 5px; "
                                                                               target="_blank"
                                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $mdocaux1; ?>"><i
                                                                                        class="fa fa-file"></i> Ver Otra
                                                                                Documentación</a>
                                                                        <?php endif; ?>
                                                                        <?php if ($rpredialar): ?>
                                                                            <a class="btn btn-primary"
                                                                               ...
                                                                               title="Visualizar Recibo Predial <?php echo $predialso == "" ? "Propietario" : "Solicitante"; ?>"><i
                                                                                        class="fa fa-file"></i> Recibo
                                                                                Predial <?php echo $predialso == "" ? "Propietario" : "Solicitante"; ?>
                                                                            </a>
                                                                        <?php endif; ?>
                                                                        <?php if ($doctopredial): ?>
                                                                            <a class="btn btn-primary"
                                                                               style="margin-bottom: 5px; "
                                                                               target="_blank"
                                                                               href="<?php echo base_url() . "assets/tramites/clavescatastralesindividual/" . $doctopredial; ?>"
                                                                               title="Visualizar Recibo Predial <?php echo $predialso == "" ? "Propietario" : "Solicitante"; ?>"><i
                                                                                        class="fa fa-file"></i> Recibo
                                                                                Predial <?php echo $predialso == "" ? "Propietario" : "Solicitante"; ?>
                                                                            </a>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group col-md-3">
                                                                            ...
                                                                            <input autocomplete="off"
                                                                                   value="<?php if(is_numeric($notario)) echo $notario; else echo $nonotario; ?>"
                                                                                   required name="folio"
                                                                                   style="text-transform:uppercase;"
                                                                                   pattern="[A-Z0-9 -/]+"
                                                                        ...
                                                                        <div class="form-group col-md-3">
                                                                            ...
                                                                            <input autocomplete="off"
                                                                                   ...
                                                                                   pattern="\d+(\.\d{1,8})?" value=""
                                                                                   class="form-control"/>
                                                                        </div>
                                                                        <div class="form-group col-md-2">
                                                                            <label for="varchar">Superficie</label><br>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group col-md-4">
                                                                            <label for="varchar">Nombre del Encargado
                                                                                IMUVII*</label>
                                                                            <input autocomplete="off"
                                                                                   value="<?php if(is_numeric($notario)) echo $nonotario; else echo $notario; ?>"
                                                                                   required name="nombre_imuvii"
                                                                                   style="text-transform:uppercase;"
                        ...
                        <div class="modal fade" id="fullnega" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-full">
                                <div class="modal-content">
                                    ...
                                    <form target="_blank"
                                          action="<?php echo base_url(); ?>docstramites/documentoclave/documentofinalnegacion_vista"
                                          method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <input name="ID" value="<?php echo $ID; ?>" type="hidden">
                                                <div class="row">
                                                    <label for="observaciones">Motivo de negación</label>
                        ...
                        <div class="modal fade" id="talon" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form target="_blank"
                                          action="<?php echo base_url(); ?>claves_catastrales_individual/vistapa"
                                          method="post">
                                        <div clas="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group input-medium date date-picker"
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   type="text" readonly="" name="fecha_ini" id="fecha_ini">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group input-medium date date-picker"
                                                            ...
                                                            <input class="form-control"
                                                                   placeholder="fecha de expedición" required
                                                                   type="text" readonly="" name="fecha_exp" id="fecha_exp"><span
                                                                    class="input-group-btn">
                                                    <button class="btn btn-primary btn-outline" type="button">
                                                        <i class="fa fa-calendar"></i>
                                                    </button>
                                        ...
                                        <script>
                                            $('#submit-all').on('click',function(){
                                                alert('Talón generado correctamente');
                                                if(window.location.href.contains('individual'))
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            $('#nooficialui').keyup(function () {
                                ...
                                //nooficial
                                $('#address').val($('#calleui').val() + " " + $('#nooficialui').val() + "" + $('#cbocoloniaui').find('option:selected').text() + " Uruapan, Michoacan");
                                initMap();
                                //calleui
                            });
                        });
                    ...
                    <script>
                        ...
                        $('input[type=radio][name=ipropietario]').change(function () {
                            if ($(this).val() == 1) {
                                $("#divPropietario").hide();
                                $('#nombreSolicitante').attr({required: false, disabled: true});//false
                            }
                            else if ($(this).val() == 2) {
                                $("#divPropietario").show();
                                $('#nombreSolicitante').attr({required: false, disabled: false});//true
                            }
                        });
                        $(document).ready(function () {
                            var $ipropietario = $('input[type=radio][name=ipropietario]:checked').val();
                            if ($ipropietario != "") {
                                if ($ipropietario == 1) {
                                    $("#divPropietario").hide();
                                    $('#nombreSolicitante').attr({required: false, disabled: true});//false
                                } else if ($ipropietario == 2) {
                                    $("#divPropietario").show();
                                    $('#nombreSolicitante').attr({required: false, disabled: false});//true
                                }
                            }
                    ...
                    <script>
                        ...
                        function iniciarAyuda() {
                            ...
                            var enjoyhint_script_steps = [
                                ...
                                {
                                    "next #paso3": 'Indique el número de cuenta predial del inmueble, este se encuentra <br> en el recibo predial como se muestra en la imagen:<br><br><img src="<?php echo base_url() . "assets/recpre.png" ?>"><br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ,
                                {
                                    "next #paso2": 'De la siguiente lista seleccione la categoría en la que se encuentra el predio<br>1.- <b>Predio Urbano :</b> Son los ubicados en el área urbana y de cada centro de población que cuenten con acción o acciones de urbanización con excepción de los predios dedicados permanentemente a fines agricolas.<br>2.-<b>Predio Sub-Urbano:</b> Predios ubicados fuera del polígono envolvente del área urbana pero dentro de la mancha urbana de cualquier comunidad, colonia, ranchería o municipio.<br>3.-<b>Predio Rústico:</b> Los que esten dedicados a la explotación de carácter agrícola, ganadera, forestal, de explotación de recursos naturales y actividades análogas.<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ,
                                {
                                    "next #paso4": 'Para facilitar la localización de su predio en el sistema, ingrese los siguientes datos como aparecen en el recibo predial.<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ,
                                ...
                                ,
                                {
                                    "next #paso6": 'Selecccione de la lista el Fraccionamiento/Condominio/Colonia/Barrio/Comunidad/Predio/Ejido en donde se localiza su predio.<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ,
                                {
                                    "next #paso7": '<span style="color:black;" >Verifique que el puntero rojo indique la ubicación correcta del predio, usted puede reacomodarlo en caso de ser necesario.<br>Presione "Siguiente" para continuar..</span>',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ,
                                ...
                                ,
                                {
                                    "next #paso11": '<br>Seleccione el tipo de trámite que solicita.<br><ul><li>Asignación de Clave Catastral: Cuando se requiere obtener la Clave Catastral por primera vez.</li><li>Modificación de Clave Catastral: Cuando la Clave Catastral actual requiere algún cambio.</li><li>Duplicado de Clave Catastral: en caso de requerirse un duplicado de la Clave.</li></ul><br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
                                ...
                                ,
                                {
                                    "next #paso11a": 'Para darle un mejor servicio, seleccione para que asunto requiere la Clave Catastral en caso de no se encuentre el motivo deseado por favor seleccione "A SOLICITUD DE PARTE (CERTIFICADA)".<br>Presione "Siguiente" para continuar..',
                                    "nextButton": {text: "Siguiente"},
                                    "skipButton": {text: "Saltar Guía"}
                                }
...
//    contentType: 'application/json',
                                            success: function (respuesta) {
                                                if (respuesta) {
                                                    ...
                                                    $('#Superficie').val(respuesta.SUPERFICIE_TOTAL != undefined ? respuesta.SUPERFICIE_TOTAL:"");
                                                    console.log(respuesta.SUPERFICIE_TOTAL);
...
//                   var am
                                                    ...
                                                    if(nombre=="CD")
                                                    {
                                                        ...
                                                        var a1 = ap.replace("?","Ñ");
                                                        var a2 = am.replace("?","Ñ");
                                                        $('#nombrepropietariodp').val(n + " " + ap + " " + am);
