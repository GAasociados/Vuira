...
<?php endif; ?>
                                        ...
                                        <?php
                                        $file = "assets/tramites/clavescatastralesindividual/" . $doctofinal;
                                        $doc = "https://vuira.irapuato.gob.mx/DocPrint/DocPrint.php?id=" . $ID;
//                                       echo $file;
                                            ...
                                            <div class="row">     
                                                ...
                                                <div class="col-md-10">
                                                    <iframe  class="center" src="<?php echo($doc);?>" width="100%" height="800" frameborder="2"></iframe>
                                                </div>
                                                <div class="col-md-1"></div>
                                            </div>
                                            <div class=" form-group col-md-12">
												...
												<button type="button" id="regresarT" class="btn btn-primary" onclick="RegresarTramite()">Regresar Tramite</button>
...
<?php $this->load->view('base/footer'); ?>
		...
		<script type="text/javascript" src="https://vuira.irapuato.gob.mx/VUIRA1.5/js/view_clave_cat_validacion.js"></script>
