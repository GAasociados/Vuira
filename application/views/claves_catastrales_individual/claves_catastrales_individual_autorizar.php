                                             ...
                                             <td style="text-align:center" width="200px">
                                               <?php
                                                    ...
                                                    if($claves_catastrales_individual->tipotramite == 1):
                                                         echo anchor(site_url('claves_catastrales_individual/autorizar_tram/'.$claves_catastrales_individual->ID),'Autorizar');
                                                    else:
                                                          echo anchor(site_url('claves_catastrales_individual_cetificado/autorizar_tram/'.$claves_catastrales_individual->ID),'Autorizar');
                                                    endif;
