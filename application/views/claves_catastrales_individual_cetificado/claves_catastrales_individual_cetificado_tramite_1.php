                                        ...
                                        foreach ($claves_catastrales_individual_certificado_data as $claves_catastrales_individual) {
                                            ...
                                            if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $claves_catastrales_individual->cbocomunidad; ?></td>
...
//                                                    echo $dfeha1;
                                                    ...
                                                    <td style="text-align:center" width="200px">
                                                        ...
                                                        <?php $resultq = $this->Usuarios_model->get_by_id($claves_catastrales_individual->auxiliar);
...
<![endif]-->
        ...
        <div class="modal fade bs-modal-md" id="small" tabindex="-1" role="dialog" aria-hidden="true">
            <form action="<?php echo base_url() . "claves_catastrales_individual_cetificado/asignar_funca1"; ?>" method="post" >
