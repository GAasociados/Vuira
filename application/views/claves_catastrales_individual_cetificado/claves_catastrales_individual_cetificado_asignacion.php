                            ...
                            <div class="page-head">
                                <div class="container-fluid">
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 10px">
                                        ...
                                        foreach ($claves_catastrales_individual_cetificado_data as $claves_catastrales_individual) {
                                            ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center" width="200px">
                                                 ...
                                                 <td><?php echo $claves_catastrales_individual->nombrepropietariodp ?></td></td>
                                                 <td><?php echo $claves_catastrales_individual->cbocomunidad ?></td></td>
                                                
                                                <td><?php echo $claves_catastrales_individual->calleui ?></td>
                                        <?php
                                                    $date1 = date("d-m-Y");
                                                    $date = new DateTime($claves_catastrales_individual->fechainicio);
