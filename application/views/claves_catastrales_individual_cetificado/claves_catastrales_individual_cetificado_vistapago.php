                            ...
                            <div class="page-head">
                                <div class="container-fluid">
                                    ...
                                    <div class="page-title">
                                        <h1>Clave Catastral Individual Certificado</h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            </div>
                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                        <li class="active">
                                            <a data-toggle="tab" class="step" aria-expanded="true">
                                                ...
                                                <b>Realize su pago para el trámite de Clave Catastral Individual Certificado </b>
                                            </a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="row">
                                            <div  class="form-group" >
                                                <div class="col-md-6 col-xs-12" >
                                                    ...
                                                    <label><?php echo "Calle: " . $calleui; ?><?php echo $nooficialui != "" ? ", N° Ext " . $nooficialui : ""; ?><?php echo $nooficialui != "" ? ", N° Int " . $nooficialinui : ""; ?><?php echo $cbocomunidad != "" ?" Comunidad: ".ucfirst(strtolower($cbocomunidad)):""; ?>
...
-->                                                       <div class=" form-group col-md-2 col-xs-12">
                                                ...
                                                <div class=" form-group col-md-6 col-xs-12">
                                                    ...
                                                    <?php if ($doctopago): ?>
                                                        <a href="<?php echo base_url() . "assets/tramites/clavescatastralesindividualcertificado/" . $doctopago; ?>">Descargar Documento</a>
                                                    <?php else: ?>
                                         ...
                                         <div class="row" >
                                                <div class=" form-group col-md-4 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url() . "assets/tramites/clavescatastralesindividualcertificado/" . $compro; ?>">Descargar Comprobante</a>
                                                    <?php else: ?>
