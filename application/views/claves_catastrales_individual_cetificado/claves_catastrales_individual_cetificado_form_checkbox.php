    ...
    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id='paso3'>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input  autocomplete="off" <?php echo $modificar1; ?>  required="" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" type="text" class="form-control"  pattern="[A-Z0-9 ,.-ÑÁÉÍÓÚ]+" name="calleui" id="calleui" placeholder="Calle" value="<?php echo $calleui; ?>" />
                                            </div>

                                            <div class=" col-md-3">
                                                <label for="varchar">Número Exterior *</label>
                                                <input  autocomplete="off" <?php echo $modificar1; ?>   required="" type="text" class="form-control" pattern="[A-Za-z0-9 -/]+" name="numext" id="numext" placeholder="Número Exterior" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $numext != "" ? $numext : "S/N"; ?>" />
                                            </div>    
                                            <div class=" col-md-2">
                                                <label for="varchar">Número Interior</label>
                                                <input  autocomplete="off"  <?php echo $modificar1; ?>  type="text" class="form-control" name="numint" pattern="[A-Za-z0-9 -/]+" id="numint" placeholder="Número Interior" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $numint; ?>" />
                                            </div> 

                                            <div class="form-group col-md-4">
                                                <label for="int"> Poblado/Localidad/Comunidad/Ejido *<?php echo form_error('cbocomunidad') ?></label>
                                                <input  autocomplete="off" <?php echo $modificar1; ?>    required type="text" class="form-control" pattern="[A-Za-z0-9 -/.ÑÁÉÍÓÚ]+" name="cbocomunidad" id="cbocomunidad" placeholder="Poblado/Localidad/Comunidad/Ejido" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();"     value="<?php echo $cbocomunidad; ?>" />
                                            </div>
                                        </div>
                                        <div class="row" id="paso4">
                                            <div class="col-md-6">
                                                ...
                                                <div class="row" >
                                                    <?php if ($this->session->userdata('tipo') == 3 || $this->session->userdata('tipo') == 4): ?>
                                                        <div class="col-md-12">
                                                            <h5 class="bold">Para Trámite con Título de Propiedad o Sentencia Jurídica</h5>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div class="form-group col-md-6">
                                                        <label for="varchar">Número de Lote  <?php echo form_error('noloteui') ?></label>
                                                        <input  autocomplete="off"  <?php echo $modificar1; ?>   type="text" class="form-control" pattern="L-[0-9A-Z -/]+"  title="El formato de este campo es (L-Número)"  name="noloteui" id="noloteui" placeholder="Número de Lote" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $noloteui; ?>" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="varchar">Manzana <?php echo form_error('nomanzanaui') ?></label>
                                                        <input autocomplete="off"  <?php echo $modificar1; ?>   type="text" pattern="M-[0-9A-Z -/]+" class="form-control" name="nomanzanaui"  title="El formato de este campo es (L-Número)"  id="nomanzanaui" placeholder="Manzana" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $nomanzanaui; ?>" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input autocomplete="off" <?php echo $modificar1; ?>   type="text" class="form-control" name="zonaloteparcela" id="zonaloteparcela" placeholder="Parcela/Solar Lote" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $zonaloteparcela != "" ? $zonaloteparcela : "S/N"; ?>" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="varchar">Zona y Porcion/Manzana</label>
                                                        <input  autocomplete="off" <?php echo $modificar1; ?>   type="text" class="form-control"  name="porcionp" id="porcionp" placeholder="Zona y Porcion/Manzana" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" value="<?php echo $porcionp != "" ? $porcionp : "S/N"; ?>" />
                                                    </div>
                                                </div>
...
//                                                            die(print_r($consulta->result(),true));
                                            ...
                                            <div class="form-group">
                                                <div  class="col-md-4" id="paso9">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input <?php echo $modificar; ?> required type="email" class="form-control" name="correonotificacionesdp" id="correonotificacionesdp" placeholder="CORREO ELECTRÓNICO" value="<?php echo $correonotificacionesdp == "" ? $this->session->userdata('correo') : $correonotificacionesdp; ?>" />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="varchar">Teléfono *<?php echo form_error('telefononotificacionesdp') ?></label>
                                                        <input <?php echo $modificar; ?> maxlength="10" required pattern="[0-9]{7,10}" type="text" class="form-control" name="telefononotificacionesdp" id="telefononotificacionesdp" placeholder="TELÉFONO" value="<?php echo $telefononotificacionesdp; ?>" pattern="[0-9]{0-10}"  title="Solo números"/>
                                                    </div>
                                                </div>
    ...
    <div class="form-group col-md-12">
                                        ...
                                        <div class="row" id="paso10">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="varchar">Título de la propiedad, Certificado Parcelario, Contrato Privado de Compraventa CORETT o Sentencia Jurídica que haya causado ejecutoria o Estado (Certificada). Deberán estar debidamente inscritos en el Registro Público. Puede adjuntar uno o varios archivos *<?php echo form_error('doctotitulo') ?></label>
                                                    <?php if ($modificar == ""): ?>
                                        ...
                                        <?php if ($this->session->userdata('tipo') == 15) { ?>
                                            <div class="row">        
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 15 && $usuarioID == $this->session->userdata('id') && $fechafinal != null): ?>
                                                    <div class="form-group">
                                                        <div id="generartalon" class="form-group col-md-4">
                                                            <a ID="2" target="_blank" class="btn btn-primary btn-lg" href="<?php echo base_url('claves_catastrales_individual_cetificado/vistapa/' . $ID) ?>"><i class="fa fa-check"></i> Generar Talón</a>
                                                        </div>
                                                    </div>
                                        ...
                                        <?php if ($this->session->userdata('tipo') == 1555 || $this->session->userdata('tipo') == 155): ?>
                                            <div class="row"> 
                                                <div class="col-md-12">
                                                    <?php if ($imuvii == 1): ?>
                                                        <div class=" form-group col-md-4" >
                                                            <a data-target="#fullimu" data-toggle="modal" class="btn btn-success"><b>Generar Documento IMUVII</b></a>
                                                        </div>
                                                    <?php else: ?>
                                                        <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <?php if ($autocat): ?>
                                                            <a  class="" target="_blank" href="<?php echo base_url() . "assets/tramites/clavescatastralesindividualcertificado/" . $autocat; ?>">Descargar</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php // if (1 == 2):  ?>
                                                <div class="form-group col-md-12">
                                                    <div class="form-group col-md-4">
                                                        <a class="btn btn-success" target="_blank" href="<?php echo base_url(); ?>docstramites/documentoanuncio/documentopagocertificado/<?php echo $ID; ?>"><b>Descargar Plantilla de Pago</b></a>
                                                    </div>
                                                    <div class="form-group col-md-4" >
                                                        <?php if (!empty($status)): ?>
                                                            <label for="varchar" id="parpadear"> <b>Documento Orden de Pago *</b> <?php echo form_error('doctopago') ?></label>
 ...
 <button type="submit" id="solicitar"class="btn btn-success  glyph-icon icon-check-square-o">Solicitar Trámite</button>
                                                ...
                                                <?php if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 1555) { ?>
                                                    <?php if ($this->session->userdata('tipo') == 155 || $this->session->userdata('tipo') == 1555) { ?>
                                                        <a href="<?php echo base_url(); ?>claves_catastrales_individual/asigna" class="btn btn-azure glyph-icon icon-arrow-circle-left">Regresar</a>
                                                    <?php } else { ?>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input required name="folio"  autocomplete="off"   style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 -/]+"  placeholder="Número de folio " value="" class="form-control" />
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input  autocomplete="off"  required name="super"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 -/]+"  placeholder="Superfice mts2 " value="" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input autocomplete="off"   required name="nombre_imuvii" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" placeholder="Nombre del Encargado "  class="form-control"/>
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input  autocomplete="off"   required  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" name="Oficio" placeholder="NÚMERO DE FOLIO" class="form-control" value=""/>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
            ...
            <div class="modal fade" id="full" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-full">
                    <div class="modal-content">
                        ...
                        <form target="_blank" id="formdocto" action="<?php echo base_url(); ?>docstramites/documentoclave/documentofinalcertificado_vista" method="post">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group col-md-4 hidden">
                                                                    ...
                                                                    <input  autocomplete="off"   value="<?php echo $noescri; ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 .-/]+"  name="no_escritura" placeholder="Númer Escritura" value="" class="form-control" value=""/>
                                                                </div>

                                                                <div class="form-group col-md-4">
                                                                    <label for="date">Fecha de título, escrituras o documento de propiedad *</label>
                                                                    <div class="input-group input-medium date date-picker" data-date-start-date="" data-date-format="dd-mm-yyyy">
                                                                        <input  value="<?php
                                                                        if ($fechaesc) {
                                                                ...
                                                                <div class="form-group col-md-6 hidden">
                                                                    ...
                                                                    <input  autocomplete="off"  value="<?php echo $notario; ?>"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 .-/ÑÁÉÍÓÚ]+"  name="notario" placeholder="Nombre del Notario Público " value="" class="form-control" />
                                                                </div>
                                                                <div class="form-group col-md-4 hidden">
                                                                    <label for="varchar">Número de notario público *</label>
                                                                    <input  autocomplete="off"  value="<?php echo $nonotario; ?>" name="no_notario" placeholder="Número de Notario Público" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 -./]+"   value="" class="form-control" />
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label for="varchar">Número de Oficio *</label>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="form-group col-md-4">
                                                                    <label for="varchar">Número de Título o Escritura*</label>
                                                                    <input  autocomplete="off"   value="<?php echo $noescri; ?>" maxlength="12"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 .-/]+"  name="no_escritura" placeholder="Número Título o Escritura" id="notitulop" class="form-control" />
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input  autocomplete="off"   readonly=""  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" pattern="[A-Z0-9 -./]+"  required name="numero_exp" placeholder="Número de Expediente " value="<?php echo $nocontrol; ?>" class="form-control" />
                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label for="varchar">Estado de Creación de Documento*</label>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label for="varchar">Ciudad de Creación de Documento  *</label>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    ...
                                                                    <input  autocomplete="off"   value="<?php echo $delegado; ?>"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();"   name="delegado" placeholder="nombre" id="delegadoti" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="hidden" id="ttramite">
                                                        <td>
                                                            <div class="form-group col-md-12" id="trrtr">
                                                                <h5>Tipo Trámite</h5>
                                                                <input name="ttramite" value="coret"  class="radiot"  type="radio" > CORETT<br>
                                                                <input name="ttramite" value="info" class="radiot"  type="radio"> INFONAVIT<br>
