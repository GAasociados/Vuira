                ...
                <ul id="sidebar-menu">
                    ...
                    <li>
                        <a href="/claves_catastrales_individual_cetificado/create_ventanilla">
                            <i class="glyph-icon icon-ban"></i>
                            <span>Clave Fraccionamiento </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="sf-with-ul" href="#" title="MenU 2">
                            ...
                            <span><h6>REPORTE CLAVE INDIVIDUAL</h6></span>
                        </a>
                        <a class="sf-with-ul" href="#" title="MenU 2">
                            <i class="glyph-icon icon-home"></i>
                            <span><h6>REPORTE CLAVE FRACC.</h6></span>
                        </a>
...
<!--                      <button class="btn btn-warning float btnAyuda" title="Ayuda" id="ayuda" onclick="iniciarAyuda()">
      ...
      <button class="btn btn-warning btnAyudaForm" title="Ayuda" id="btnGuardarCtaSuspendida"> 
          <h4><i class="glyph-icon icon-question-circle "></i>&nbsp;Ayuda</h4> 
        </button>
                                    ...
                                    ?>
                        <button class="btn btn-warning btnAyudaForm" title="Ayuda" id="btnGuardarCtaSuspendida" onclick="iniciarAyuda()"> 
          <h4><i class="glyph-icon icon-question-circle "></i>&nbsp;Ayuda</h4> 
        </button>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
          <p data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" style="cursor:pointer;">I.¿Eres propietario del inmueble?.
        </h4>
    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
          <p data-toggle="collapse" data-parent="#accordion" href="#collapseThree" style="cursor:pointer;">II. Identificación y Ubicación del Inmueble.</p>
        </h4>
    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
          <p data-toggle="collapse" data-parent="#accordion" href="#collapseFour" style="cursor:pointer;">III. DATOS DEL PROPIETARIO</p>
        </h4>
    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
          <p data-toggle="collapse" data-parent="#accordion" href="#collapseFour2" style="cursor:pointer;">IV. ADJUNTE LOS SIGUIENTES ARCHIVOS EN ORIGINAL</p>
        </h4>
    </div>
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12">
                                              ...
                                              <!-- Botones Flotantes --><div class="button-group pull float">
                                                     ...
                                                     <button data-loading-text="<i class='fa fa-spinner fa-spin '></i> Realizar Trámite" id="solicitar" type="submit"  class="btn btn-success glyph-icon icon-play">Solicitar Traámite</button>
