                            ...
                            <div class="page-head">
                                <div class="container-fluid">
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 10px">
                                        ...
                                        foreach ($claves_catastrales_individual_cetificado as $claves_catastrales_individual_cetificado) {
                                            if ($this->session->userdata('tipo') == 15 || $this->session->userdata('tipo') == 155) {
                                                ...
                                                <?php if ($claves_catastrales_individual_cetificado->notificacion == 1) { ?>
                                                    ...
                                                    <tr>
                                                    <?php } ?>
                                                    <td><?php echo $claves_catastrales_individual_cetificado->nocontrol; ?></td>
...
//                                                    echo $dfeha1;
                                                    ...
                                                    <td style="text-align:center" width="200px">
                                                        ...
                                                        //echo ' | ';
                                                        echo anchor(site_url('claves_catastrales_individual_cetificado/update_ventanilla/' . $claves_catastrales_individual_cetificado->ID), 'Actualizar');
                                                        ?>
                                                    ...
                                                    <?php if ($claves_catastrales_individual_cetificado->notificacion == 0) { ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (empty($claves_catastrales_individual_cetificado->doctofinal)) {
                                                                ...
                                                                if ($claves_catastrales_individual_cetificado->validacion == 1) {
                                                        ...
                                                        <td style="text-align:center" width="200px">
                                                            ...
                                                            if ($claves_catastrales_individual_cetificado->status < 4) {
                                                                ...
                                                                echo anchor(site_url('claves_catastrales_individual_cetificado/vistapago/' . $claves_catastrales_individual_cetificado->ID), 'Realizar Pago');
                                                            }
                                                            ?>
                                                        </td>
                                                    </tr>
