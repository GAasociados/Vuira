...
<!--                        <button class="btn btn-warning btnAyudaForm" title="Ayuda" id="ayuda" onclick="iniciarAyuda()"> 
          <h4><i class="glyph-icon icon-question-circle "></i>&nbsp;Ayuda</h4> 
                    ...
                    <h2>Reportes Claves Catastrales Individual con Certificado.</h2><br>
                    ...
                    <div id="panel-captura-avaluo" class="panel">
                     ...
                     <a href="<?php echo base_url(); ?>infotramites/info_atencion_de_claves_catastrales_individual" class="btn btn-azure glyph-icon icon-arrow-circle-left">Regresar</a>
                                    ...
                                    <form class="" action=" <?php echo base_url('claves_catastrales_individual_cetificado/reportefinal'); ?> " method="post">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input maxlength="5"  class="form-control" type="text" pattern="[0-9]+" name="seguimiento" value="" placeholder="Buscar por Nombre o Apellido del Propietario">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Año</label>
