  ...
  <div class="page-wrapper">
    ...
    <div class="page-wrapper-row full-height">
      <div class="page-wrapper-middle">
            ...
            <div class="page-content">
              <div class="container-fluid">
                ...
                <div class="page-content-inner">
                  <form class="form-horizontal" role="form" action="<?php echo base_url('index.php/tramites/autorizacionocupacionconstruccion/updatetramfuncionario');?>" method="POST">
                    <div class="tab-content">
                        <a href="<?php echo base_url(); ?>motrarafuncionario/info_autorizacion_ocupacion_construccion" class="btn btn-primary">Cancelar</a>
                        <br><br>
                      <div class="tab-pane active" id="tab1">
                        <ul class="nav nav-pills nav-justified steps">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" name="nombrepropietariodg" placeholder="Nombre del Propietario" readonly value="<?php echo $nombrepropietariodg; ?>" id="nombrepropietariodg"/>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" readonly value="<?php echo $apellidopaternopropietariodg;?>" name="apellidopaternopropietariodg" placeholder="Apellido Paterno del Propietario"   id="apellidopaternopropietariodg"/>
                              <!-- <span class="help-block"></span><-->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" readonly value="<?php echo $apellidomaternopropietariodg;?>" name="apellidomaternopropietariodg" placeholder="Apellido Materno del Propietario"   id="apellidomaternopropietariodg"/>
                              <!-- <span class="help-block"></span><-->
                            </div>
                          </div>

                          <div>
                            <input type="hidden" readonly value="<?php echo $ID; ?>" id="numtram" name="ID">
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" name="nombresolicitantedg"  id="nombresolicitantedg" placeholder="Nombre del Representante" readonly value="<?php echo $nombresolicitantedg; ?>"/>
                              <!-- <span class="help-block"></span><-->
                              <!-- >-->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" readonly value="<?php echo $apellidopaternosolicitantedg; ?>" name="apellidopaternosolicitantedg" placeholder="Apellido Paterno del Representante"   id="apellidopaternosolicitantedg"/>
                              <!-- <span class="help-block"></span><-->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" readonly value="<?php echo $apellidomaternosolicitantedg; ?>" name="apellidomaternosolicitantedg" placeholder="Apellido Materno del Representante"   id="apellidomaternosolicitantedg"/>
                              <!-- <span class="help-block"></span><-->
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" name="calledg" placeholder="Calle" id="calle" readonly value="<?php echo $calledg; ?>"/>
                              <!-- <span class="help-block"></span><-->
                              <!-- >-->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" id="numerodg" name="numerodg" placeholder="Número" readonly value="<?php echo $numerodg; ?>"/>
                              <!-- <span class="help-block"></span><-->
                              <!-- -->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <select readonly class="form-control" name="coloniadg" id="cbocols">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input id="correodg" type="email" class="form-control" name="correodg" placeholder="Correo Electronico" readonly value="<?php echo $correodg; ?>"/>
                              <!-- <span class="help-block"></span><-->
                              <!-- >-->
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <span></span>
                              <input type="text" class="form-control" name="telefonodg" id="telefonodg" placeholder="(462) 123-34-21 Ext.123" readonly value="<?php echo $telefonodg; ?>"/>
                              <!--
                              <span class="help-block"></span><-->
                              <!-- >
                            -->
                      ...
                      <div class="tab-pane fade" id="tab2">
                        ...
                        <div class="form-group">
                          <div class="form-group col-md-6"> <!-- this -->
                            ...
                            <div class="col-md-9"> <!-- this -->
                              <span></span>
                              <input type="text" class="form-control" name="calleui" id="calleui" placeholder="Calle" readonly value="<?php echo $calleui; ?>"/>
                            </div>
                          </div>
                          ...
                          <div class="form-group col-md-6"> <!-- this -->
                            ...
                            <div class="col-md-9"> <!-- this -->
                              <span></span>
                              <input type="text" class="form-control" name="nodeloteui"  id="nodeloteui" placeholder="No. de Lote" readonly value="<?php echo $nodeloteui; ?>"/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="text" class="form-control" name="manzanaui" id="manzanaui" placeholder="Manzana" readonly value="<?php echo $manzanaui;?>" />
                            </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="text" class="form-control" name="nooficialui" id="nooficialui" placeholder="No. Oficial" readonly value="<?php echo $nooficialui; ?>"/>
                            </div>
                        ...
                        <div class="form-group">
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <select  readonly class="form-control" name="cbocolsui" tabindex="-1"  id="cbocolsui">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="text" placeholder="Superficie del Predio" class="form-control" name="superficiepredioui" id="superficiepredioui" readonly value="<?php echo $superficiepredioui; ?>"/>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="text" placeholder="Superficie Construida"class="form-control" name="superficieconstruidaui"  id="superficieconstruidaui" readonly value="<?php echo $superficieconstruidaui; ?>"/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="text" class="form-control" name="bardeoui" id="bardeoui" placeholder="Bardeo Metros Lineales" readonly value="<?php echo $bardeoui; ?>"/>
                            </div>
                          </div>
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="number" class="form-control" name="nonivelesui"  id="nonivelesui"placeholder="No. de Niveles" readonly value="<?php echo $nonivelesui; ?>"/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="number" class="form-control" placeholder="No. Cajones de Estacionamiento" name="nocajonesui" id="nocajonesui"  readonly value="<?php echo $nocajonesui; ?>"/>
                            </div>
                          </div>
                          <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                              <span></span>
                              <input type="number" class="form-control" name="noviviendasui" id="noviviendasui" placeholder="No. de Viviendas" readonly value="<?php echo $noviviendasui; ?>" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <span></span>
                            <input type="text" readonly placeholder="Porcentaje de avance de Obra" class="form-control" name="porcentajeavanceui" id="porcentajeavanceui" readonly value="<?php echo $porcentajeavanceui; ?>"/>
                          </div>
                        </div>
                            ...
                            <div class="row">
                              ...
                              * element that contains the map. */
                              ...
                              <div id="floating-panel">
                                <input id="address" type="text" class="class="form-control"" readonly value="<?php echo $callenorte ?>" name="callenorte">
                    ...
                    <div class="col-md-9">
                    <span></span>
                    <input type="text" class="form-control" name="callesur" id="callesur"  placeholder="Calle Al Sur" readonly value="<?php echo $callesur; ?>"/>
                  </div>
                </div>
                <br>
                <!- this
              ...
              <div class="col-md-9">
              <span></span>
              <input type="text" class="form-control" name="calleeste" id="calleeste" placeholder="Calle Al Oriente" readonly value="<?php echo $calleeste; ?>"/>
            </div>
          </div>
          <br>
          <!- this -
        ...
        <div class="col-md-9">
        <span></span>
        <input type="text" class="form-control" name="calleoeste" id="calleoeste" placeholder="Calle Al poniente" readonly value="<?php echo $calleoeste; ?>"/>
      </div>
    </div>
    <br>
    <!- this --
...
<option readonly value="<?php echo $seccion; ?>"> <?php echo $seccion;?> </option>
  ...
  <ul class="nav nav-pills nav-justified steps">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        ...
        <select readonly class="form-control" name="nombreperitodp" tabindex="-1"  id="cbonombreperitodp">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <!-- <span class="help-block"></span><-->
        <!-- >-->
        <select readonly class="form-control" name="nombreperitoresponsabledp" tabindex="-1"  id="cbonombreperitoresponsabledp">
          <option readonly value="<?php echo $nombreperitoresponsabledp; ?>"><?php echo $arrayperitoesp[0]->nombre; ?></option>
          <!-- <option value="Option 1">Option 1</option> -->
        </select>
      </div>
    </div>
                ...
                <span class="btn blue btn-file">
                  ...
                  <div class="col-md-3">
                    ...
                    <select class="form-control" name="verificador" id="verificador">
                          <option value = "1">Verificador A</option>
                          <option value = "2">Verificador B</option>
                          <option value = "3">Verificador C</option>
                    </select>
                    </div>
                    
                    <div class="col-md-6">
                     <label for="varchar" id="parpadearxd"> <b>Documento Verificador *</b></label>
                            <input type="file" multiple name="doctoverificador[]" id="doctoverificador"/>
                            <?php if(!empty($doctoverificador)): ?>
                              <a href="<?php echo base_url()."assets/tramites/construccion/".$doctoverificador; ?>">Descargar</a>
                    <?php endif; ?>
                    </div>
                </div>
                                        ...
                                        <label class="control-label col-md-3">Documento de Pago del Trámite<span class="required"> * </span>
                                          ...
                                          <a href="<?php echo base_url()."assets/pagos/"?>PagoUsoDeSuelo.xlsx"><b>Descargar Plantilla de Pago</b></a>
                                          <div class="col-md-3">
                                        ...
                                        <label class="control-label col-md-3">Documento Final del Trámite
                                        </label>
                                        <div class="col-md-3">
                                           <div id="iddocsfinalname" style="display: none;"><?php echo $docsfinal;?></div>

                                           <input type="hidden" value="<?php echo $docsfinal; ?>" name="inpdocsfinal">

                                           <div class="fileinput fileinput-new" data-provides="fileinput">
                                              <span class="btn blue btn-file">
                                                 <span class="fileinput-new"> Seleccionar Archivo </span>
                                                 <span class="fileinput-exists"> Cambiar </span>
                                                 <input type="hidden" value="" name="..."><input type="file" name="docsfinal[]" multiple class="multi"> </span>
                                                 <?php if (empty($docsfinal)){ ?>
                                                 <a href="#">Sin Archivo</a>
                                                 <?php } else { ?>
                                                 <br>
                                                 <a href="<?php echo base_url()."assets/tramites/construccion/".$docsfinal; ?>" id="iddocsfinal">Descargar Documento</a>
                                                 <?php } ?>
                                                 <span class="fileinput-filename"></span> &nbsp;
                                                 <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput"> </a>
                                              </div>
                                        ...
                                        <label class="control-label col-md-1">No. Permiso<span class="required"> * </span>
                                          </label>
                                          <div>
                                            <div class="col-md-4">
                                              <span></span>
                                              <input type="text" placeholder="No. de Control" class="form-control" name="nocontroldp" value="<?php echo $nocontroldp; ?>" id="idnocontroldps"/>
                                            </div>
                                          </div>
                                        </div>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                  ...
                                                  <?php if ($status == 1): ?>
                                                    ...
                                                    <option value = "2">En Espera de Actualización de Información</option>
                                            ...
                                            <div class="row">
                                            <div class="form-group col-md-12">
                                              <h4>Mensaje Para el Ciudadano</h4>
                                              <textarea rows="5" class="form-control" placeholder="Mensaje Para el Ciudadano" name="mensaje" id="idmensaje" ><?php echo $mensaje;?></textarea>
                                            </div>
                                            </div>
