                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" class="form-control" name="nodeloteui"  placeholder="Núm. de Lote" id="noloteui" value="<?php echo $noloteui; ?>"/>  
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" class="form-control" name="nomanzanaui" value="<?php echo $nomanzanaui; ?>"  placeholder="Manzana" id="nomanzanaui" />
                                             </div>
                                          </div>
                                          <div class="form-group col-md-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" placeholder="Cuenta Predial" class="form-control" name="predialui" id="predialui" value="<?php echo $predialui; ?>"/>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" placeholder="Uso Actual del Predio"class="form-control" name="usopredioui" id="usopredioui" value="<?php echo $usopredioui; ?>"/>
                                             </div>
                                          </div>
                                       </div>
...
<div class="col-md-9">
<span></span>
<input type="text" class="form-control" name="callesurui"  placeholder="Calle Al Sur" id="callesurui" value="<?php echo $callesurui; ?>"/>
</div>
</div>
<br>
<!- this -
...
value="<?php echo $calleponienteui; ?>"/>
</div>
</div>
<br>
<!- this -
...
<option value="<?php echo $ubucacioncroquisui; ?>">
<?php echo $ubucacioncroquisui; ?></option>
...
<div class="form-group">
   ...
   <div class="col-md-4">            
      <a class="btn btn-primary btn-outline" href="#tab2" data-toggle="tab" id="idtab2"> Siguiente <i class="icon-action-redo"></i>
      </a>
   </div>
</div>
<!-- 
...
<div class="form-group">
   ...
   <div class="col-md-4">
      ...
      <a class="btn btn-primary btn-outline" href="#tab3" id="idtab3" data-toggle="tab"> Siguiente <i class="icon-action-redo"></i></a>
   </div>
</div>
<!-- 
         ...
         <div class="col-md-3">
            <div class="fileinput fileinput-new" data-provides="fileinput">
               <span class="btn blue btn-file">
                  ...
                  <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput"> </a>
                 <!-- this -->
                     <div id="escriturapublicaname" style="display: none;"><?php echo $escriturapublica;?></div>

                     <input type="hidden" value="<?php echo $escriturapublica; ?>" name="escriturapublica">

                     <?php if (empty($escriturapublica)){ ?>
                     <a href="#">Sin Archivo</a>   
                     <?php } else { ?>
                     <br>
                     <a href="" id="escriturapublica">Descargar Archivo
                     </a>
                     <?php } ?>
                     <!-- this -->
               </div>
            ...
            <div class="col-md-3">
               <div class="fileinput fileinput-new" data-provides="fileinput">
                  <span class="btn blue btn-file">
                     ...
                     <!-- this -->
                     <div id="recibopredialname" style="display: none;"><?php echo $recibopredial;?></div>

                     <input type="hidden" value="<?php echo $recibopredial; ?>" name="recibopredial">

                     <?php if (empty($recibopredial)){ ?>
                     <a href="#">Sin Archivo</a>   
                     <?php } else { ?>
                     <br>
                     <a href="" id="recibopredial">Descargar Archivo
                     </a>
                     <?php } ?>
                     <!-- this -->
                  </div>
