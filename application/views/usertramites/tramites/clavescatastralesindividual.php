                                    ...
                                    <ul class="nav nav-pills nav-justified steps">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" class="form-control" name="predialui" placeholder="Núm. Cuenta Predial" id="predialui" >
                                             </div>
                                          </div>
                                          <div>
                                       ...
                                       <div class="form-group">
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" class="form-control" name="noloteui"  placeholder="Núm. de Lote" id="noloteui" />  
                                             </div>
                                          </div>
                                       ...
                                       <div class="form-group">
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" placeholder="Superficie del Terreno"class="form-control" name="superficieterrenoui"  id="superficieterrenoui" />
                                             </div>
                                          </div>
                                          <div class="form-group col-md-6">
                                             ...
                                             <div class="col-md-9">
                                                <span></span>
                                                <input type="text" placeholder="Superficie de Construcción"class="form-control" name="superficieconstruccionui" id="superficieconstruccionui" />
                                             </div>
                                          </div>
                                       </div>
         ...
         <!-- end map -->
                                       ...
                                       <div class="tab-pane fade" id="tab2">
                                          ...
                                          <div class="form-group"> 
                                             ...
                                             <div class="col-md-4">
                                                <span></span>
                                                <input type="text" class="form-control" name="nombrerepresentantelegaldp" placeholder="Nombre del  Representante Legal" id="nombrerepresentantelegaldp" />
                                                <!-- <span class="help-block"></span><-->
                                                <!-- >-->
                                             </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-4">
                                                <span></span>
                                                <input type="text" class="form-control" name="callenotificacionesdp" placeholder="Calle" id="callenotificacionesdp" />
                                                <!-- <span class="help-block"></span><-->
                                                <!-- >-->
                                             </div>
                                          </div>
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-4">
                                                <span></span>
                                                <input type="text" class="form-control" name="numeronotificacionedp" placeholder="Número" id="numeronotificacionedp" />
                                                <!-- <span class="help-block"></span><-->
                                                <!-- >-->
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-4">
                                                <span></span>
                                                <input type="email" class="form-control" name="correonotificacionesdp" placeholder="Correo Electronico" id="correonotificacionesdp" />
                                                <!-- <span class="help-block"></span><-->
                                                <!-- >-->
                                             </div>
                                          </div>
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-4">
                                                <span></span>
                                                <input type="text" class="form-control" name="telefononotificacionesdp" placeholder="Teléfono" id="telefononotificacionesdp" />
                                                <!-- <span class="help-block"></span><-->
                                                <!-- >-->
                                             </div>
                                          </div>
                                       ...
                                       <div class="tab-pane fade" id="tab3">
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Edad Estimada"class="form-control" name="edadestimada" id="edadestimada" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Herreria" class="form-control" name="herreria" id="herreria" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Muros"class="form-control" name="muros" id="muros" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Inst. Eléctricas" class="form-control" name="instelectricas" id="instelectricas" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Columnas"class="form-control" name="columnas" id="columnas"  />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Inst. Sanitarias" class="form-control" name="instsanitarias" id="instsanitarias" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   ...
                                                   <input type="text" placeholder="Entrepisos"class="form-control" name="entrepisos" id="entrepisos" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Inst. Especiales" class="form-control" name="instespeciales" id="instespeciales" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Techos"class="form-control" name="techos" id="techos" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Acabados Exteriores" class="form-control" name="acabadosext" id="acabadosext" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Pisos"class="form-control" name="pisos" id="pisos" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Pintura" class="form-control" name="pintura" id="pintura" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Puertas"class="form-control" name="puertas" id="puertas" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" placeholder="Mueble de Baño" class="form-control" name="mueblebaño" id="mueblebaño" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Ventanas"class="form-control" name="ventanas" id="ventanas" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Fachada" class="form-control" name="fachada" id="fachada" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" placeholder="Carpintería"class="form-control" name="carpinteria" id="carpinteria" />
                                                </div>
                                             </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                   <span></span>
                                                   <input type="text" placeholder="Número de Plantas" class="form-control" name="noplantas" id="noplantas" />
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <a class="btn btn-primary btn-outline" href="#" id="idtab4" data-toggle="tab"> Siguiente <i class="icon-action-redo"></i></a>
                                             </div>
                                          </div>
