                            ...
                            <div class="page-head">
                                <div class="container-fluid">
                                    ...
                                    <div class="page-title">
                                        <h1>Regístrate <h5><a class="btn btn-info" href="<?php echo base_url("index.php/user/registermorales"); ?>">Registrate Aquí Si Eres Una Persona Moral</a></h5></h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            </div>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <div class="page-content-inner">
                                        <!-- BEGIN LOGIN FORM -->
                                        <form id="form-registro" class="form-horizontal" role="form" action="<?php echo base_url('index.php/user/register/guardar'); ?>" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                      <i class="icon-user font-blue">*</i>
                                                      <input class="form-control placeholder-no-fix" type="text" placeholder="CURP" name="curp" maxlength="20" style="text-transform: uppercase" required />
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-icon">
                                                                <i class="icon-direction font-blue">*</i>
                                                                <input class="form-control placeholder-no-fix" type="number" placeholder="Código Postal" name="cp" required  id="codigop" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-icon">
                                                                ...
                                                                <input class="form-control placeholder-no-fix" type="text" placeholder="Teléfono o Celular" required name="telefono"  id="mask_phone" />
                                                            </div>
