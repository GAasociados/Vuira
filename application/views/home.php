                            ...
                            <div class="page-head">
                                <div class="container-fluid">
                                    ...
                                    <div class="page-title">
                                        <h1>¡Bienvenido a la Ventanilla Universal de trámites y servicios de Irapuato! </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            </div>
                                    ...
                                    <!-- BEGIN PAGE CONTENT INNER -->
                                     <div class="page-content-inner">
                                        <div class="m-heading-1 border-blue m-bordered">
                                            <p>En esta Ventanilla Universal podrás realizar trámites digitales de forma sencilla, segura y eficiente, con procesos rápidos y confiables, así como información oportuna de los trámites.
                                            Este esfuerzo se desarrolla con la intención de simplificar los trámites municipales y facilitar el crecimiento económico del Municipio, promoviendo la competencia y la productividad.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="page-content-inner">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <a href="<?php echo base_url('index.php/infotramites/info_permisos_de_anuncios_autosoportados_azoteas'); ?>">
                                                    <img src="<?php echo base_url(); ?>assets/images/AnunciosAzotea.png" alt="Anuncios" class="logo-default" style="width: 60%; height: 100%; margin: 1%;">
                                                </a>
                                            </div>

                                            <div class="col-md-3 col-sm-6">
                                                <a href="<?php echo base_url('index.php/infotramites/Info_permisos_de_anuncios_adosados_rotulados'); ?>">
                                                    <img src="<?php echo base_url(); ?>assets/images/AnunciosRotulados.png" alt="logo" class="logo-default" style="width: 60%; height: 100%; margin: 1%;">
                                                </a>
                                            </div>
                                        </div>
                                        <br><br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <a href="<?php echo base_url() . 'infotramites/info_autorizacion_ocupacion_construccion'; ?>">
                                                    <img src="<?php echo base_url(); ?>assets/images/TerminacionObra.png" alt="Ocupacion" class="logo-default" style="width: 60%; height: 100%; margin: 1%;">
                                                </a>
                                            </div>
