                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 10px">
                                        ...
                                        foreach ($Claves_catastrales_fraccionamiento_data as $claves_catastrales_individual) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                        if($resultq = $this->Usuarios_model->get_by_id($claves_catastrales_individual->auxiliar)<>'' || $resultq = $this->Usuarios_model->get_by_id($claves_catastrales_individual->auxiliar)<>null)
                                                        {
...
//                                            
                                                ...
                                                <td style="text-align:center" width="200px">
                                                    ...
                                                    //echo ' | ';
                                                    echo anchor(site_url('Claves_catastrales_fraccionamiento/Clave/' . $claves_catastrales_individual->ID), 'Generar Clave');
                                                    ?>
                                                </td>
